...
export default class extends Migration {
    ...
    async processRemovedPlugins() {
        ...
        if (pluginsToBeDeleted.length) {
            ...
            this.app.log.warn(getAutoDeletePluginsWarning(pluginsToBeDeleted.map((plugin) => plugin.packageName || plugin.name)));
        }
...
//# sourceMappingURL=20240424125531-pro-plugins-detect.js.map
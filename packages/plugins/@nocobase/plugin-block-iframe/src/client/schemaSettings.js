...
const IframeProvider = (props) => {
  return React.createElement(FlagProvider, { collectionField: true }, props.children);
};
const getVariableComponentWithScope = (Com) => {
  return (props) => {
    ...
    return React.createElement(Com, { ...props, scope: scope });
  };
};
  ...
  items: [
    {
      ...
      useComponentProps() {
        ...
        const descriptionContent = React.createElement(
          React.Fragment,
          null,
          React.createElement(
            'span',
            { style: { marginLeft: '.25em' }, className: 'ant-formily-item-extra' },
            t('Syntax references'),
            ':',
          ),
          ' ',
        ...
        return {
                    ...
                    'x-component': (props) => {
                      return React.createElement(Select, {
                        ...
                        options: [
                          ...
                          {
                            value: 'geolocation',
                            label: React.createElement(AllowOptionsHelp, { type: 'geolocation' }),
                          },
          ...
          ModalContextProvider: (modalProps) => {
            return React.createElement(
              VariableScope,
              { scopeId: fieldSchema?.['x-uid'], type: 'iframeBlock' },
              modalProps.children,
            );
          },

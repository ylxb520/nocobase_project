...
import { ButtonEditor, ExtendCollectionsProvider, Plugin, RemoveButton, SchemaSettings, useSchemaToolbar, } from '@nocobase/client';
...
function WorkflowCCProvider(props) {
    return React.createElement(ExtendCollectionsProvider, { collections: [ccCollection] }, props.children);
}
export class PluginWorkflowCCClient extends Plugin {
    ...
    async load() {
        ...
        this.app.schemaSettingsManager.add(new SchemaSettings({

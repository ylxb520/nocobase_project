  ...
  steps: {
    import: {
      handler: async (ctx, params) => {
        ...
        const ImportDialogContent = observer(({ popover }) => {
          const { t } = ctx;
          ...
          if (state.status === 'importing') {
            return React.createElement(
              ...
              React.createElement(Spin, {
                ...
                indicator: React.createElement(LoadingOutlined, { spin: true, style: { fontSize: 24 } }),
              }),
            );
          }
          if (state.status === 'imported') {
            ...
            return React.createElement(
              Space,
              { direction: 'vertical', align: 'center', style: { width: '100%', padding: 24 } },
              React.createElement(ExclamationCircleFilled, { style: { fontSize: 72, color: '#1890ff' } }),
              React.createElement('p', null, renderResult(state.result)),
              React.createElement(
                Space,
                null,
                meta?.failureCount > 0 &&
                  React.createElement(
                    Button,
                    { onClick: downloadFailureDataHandler },
                    t('To download the failure data'),
                  ),
                React.createElement(
                  Button,
                  {
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(SchemaField, {
                ...
                scope: { t: ctx.t, handelDownloadXlsxTemplateAction },
              }),
            ),
            React.createElement(
              FormButtonGroup,
              { align: 'right' },
              React.createElement(Button, { onClick: () => popover.close() }, t('Cancel')),
              React.createElement(
                Button,
                {
                  type: 'primary',
        ...
        await ctx.viewer.open({
          ...
          content: (popover) => {
            return React.createElement(ImportDialogContent, { popover: popover });
          },
        });
      },
    },
...
//# sourceMappingURL=ImportActionModel.js.map

...
export const GoogleMapsBlock = (props) => {
    ...
    const onSelectingComplete = useMemoizedFn(() => {
        ...
        const selectedOverlays = overlays.filter((o) => {
            if (o === overlay || o.get(OVERLAY_KEY) === undefined)
                return;
    ...
    useEffect(() => {
        if (!collectionField || !dataSource?.length || !mapRef.current?.map)
            return;
        ...
        if (collectionField.type === 'point' && lineSort?.length && overlays?.length > 1) {
            ...
            overlays[0].setZIndex(138);
            overlays[overlays.length - 1].setZIndex(138);
            ...
            overlays.push(...[
                mapRef.current.setOverlay('lineString', positions.map((p) => [p.lng(), p.lat()]), {
                    strokeColor: '#4e9bff',
                    fillColor: '#4e9bff',
                    strokeWeight: 2,
                    cursor: 'pointer',
    ...
    return (React.createElement("div", { className: css `
        ...
        height: 100%;
      ` },
        isMapInitialization && (React.createElement(React.Fragment, null,
            ...
            ` },
                React.createElement(Space, { direction: "vertical" },
                    ...
                    selectingMode === 'selection' ? (React.createElement(Button, { type: "primary", icon: React.createElement(CheckOutlined, null), title: t('Confirm selection'), onClick: onSelectingComplete })) : null)),
            React.createElement(RecordProvider, { record: record, parent: parentRecordData },
                React.createElement(MapBlockDrawer, null)))),
        React.createElement(GoogleMapsComponent, { ...props, ref: mapRefCallback, style: { height: fixedBlock ? '100%' : null }, zoom: zoom, disabled: true, block: true, overlayCommonOptions: {
                strokeColor: '#F18b62',
                fillColor: '#F18b62',
            } })));
};

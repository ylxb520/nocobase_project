...
export const MapBlockComponent = withSkeletonComponent((props) => {
    ...
    return (React.createElement(Component, { ...props, ...mapFieldCollectionField?.getComponentProps?.(), collectionField: mapFieldCollectionField, markerFieldCollectionField: markerFieldCollectionField }));
}, {
    displayName: 'MapBlockComponent',
});
//# sourceMappingURL=MapBlockComponent.js.map
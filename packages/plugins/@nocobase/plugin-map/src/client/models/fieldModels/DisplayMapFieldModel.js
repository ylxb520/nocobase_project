...
export const PointReadPretty = (props) => {
    ...
    return React.createElement(MapComponent, { readonly: true, disabled: true, mapType: mapType, ...props, type: type });
};
export class DisplayMapFieldModel extends DisplayTitleFieldModel {
    ...
    renderComponent(value) {
        return (React.createElement(PointReadPretty, { ...this.props, value: value, collectionField: this.context.collectionField, type: this.getMapFieldType() }));
    }
}
...
//# sourceMappingURL=DisplayMapFieldModel.js.map
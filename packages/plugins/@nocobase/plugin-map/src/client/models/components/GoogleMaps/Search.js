...
export const Search = (props) => {
    ...
    return (React.createElement("div", { className: css `
        ...
        width: calc(100% - 20px);
      ` },
        React.createElement(Select, { id: "google-map-search", showSearch: true, allowClear: true, style: {
                background: 'rgba(255, 255, 255, 0.8)',
            }, placeholder: t('Enter keywords to search'), filterOption: false, onSearch: onSearch, onSelect: onSelect, options: options })));
};

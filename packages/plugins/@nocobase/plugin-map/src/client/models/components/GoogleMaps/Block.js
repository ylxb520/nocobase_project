...
export const GoogleMapsBlock = (props) => {
    const { collectionField, marker, dataSource, fixedBlock, zoom, setSelectedRecordKeys, lineSort, fields, name, primaryKey, mapField, associationCollectionField, onOpenView, } = props;
    ...
    return (React.createElement("div", { className: css `
      ...
      ` },
        ...
        React.createElement(GoogleMapsCom, { ...props, ref: mapRefCallback, style: { height: fixedBlock ? '100%' : null }, zoom: zoom, disabled: true, block: true, overlayCommonOptions: {
                strokeColor: '#F18b62',
                fillColor: '#F18b62',
            } })));
};

...
export const AMapBlock = (props) => {
    ...
    return (React.createElement("div", { className: css `
      ...
      ` },
        ...
        React.createElement(AMapCom, { ...props, ref: mapRefCallback, style: { height: fixedBlock ? '100%' : null }, zoom: zoom, disabled: true, block: true, overlayCommonOptions: {
                strokeColor: '#F18b62',
                fillColor: '#F18b62',
            } })));
};

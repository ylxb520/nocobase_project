 ...
 */
import { PopupContextProvider, useCollection, useCollectionManager, usePopupUtils, useProps, withDynamicSchemaProps, } from '@nocobase/client';
...
export const MapBlock = withDynamicSchemaProps((props) => {
    ...
    return React.createElement(MapBlockComponent, { ...fieldComponentProps, ...props, collectionField: collectionField });
});

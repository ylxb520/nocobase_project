...
export const MapBlockInitializer = () => {
    ...
    return (React.createElement(DataBlockInitializer, { componentType: `Map`, icon: React.createElement(TableOutlined, null), onCreateBlockSchema: async ({ item }) => {
                                ...
                                properties: {
                                    field: {
                                        ...
                                        default: mapFieldOptions.length
                                            ? [mapFieldOptions[0].value, mapFieldOptions[0].children?.[0].value].filter((v) => v !== undefined && v !== null)
                                            : [],
                                    },
                                    marker: {
        ...
        }, title: t('Map block'), ...itemConfig }));
};
//# sourceMappingURL=MapBlockInitializer.js.map
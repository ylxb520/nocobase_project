...
export const MapBlockOptions = (props) => {
    return (React.createElement(SchemaComponentOptions, { scope: { useMapBlockProps }, components: { MapBlockInitializer, MapBlockDesigner, MapBlockProvider, MapBlock } }, props.children));
};

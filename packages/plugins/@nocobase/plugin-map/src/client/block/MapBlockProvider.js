...
const InternalMapBlockProvider = (props) => {
    ...
    return (React.createElement(SchemaComponentOptions, { scope: { selectedRecordKeys } },
        React.createElement(MapBlockContext.Provider, { value: {
                field,
                service,
                resource,
                fieldNames,
...
const useMapBlockParams = (params) => {
...
export const MapBlockProvider = (props) => {
    ...
    return (React.createElement(BlockProvider, { name: "map", ...props, runWhenParamsChanged: true, params: { ...params, appends, paginate: false, sort: uField.componentProps.lineSort } },
        React.createElement(InternalMapBlockProvider, { ...props })));
};
...
//# sourceMappingURL=MapBlockProvider.js.map
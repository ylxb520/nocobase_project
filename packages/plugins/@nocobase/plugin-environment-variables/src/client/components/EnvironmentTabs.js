    ...
    React.createElement(Table, {
      ...
      columns: [
        ...
        },
        {
          title: t('Type'),
          dataIndex: 'type',
          render: (value) => React.createElement(Tag, { color: typEnum[value].color }, typEnum[value].label),
        },
        {
          title: t('Value'),
          ellipsis: true,
          render: (record) => React.createElement('div', null, record.type === 'default' ? record.value : '******'),
        },
        {
          title: t('Actions'),
          width: 200,
          render: (record) =>
            React.createElement(
              Space,
              null,
              React.createElement('a', { onClick: () => handleEdit(record) }, t('Edit')),
              React.createElement('a', { onClick: () => handleDelete(record) }, t('Delete')),
            ),
        },
      ],
      rowSelection: {
...
export function EnvironmentTabs() {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        Flex,
        { justify: 'end', style: { marginBottom: 16 } },
        React.createElement(
          Space,
          null,
          React.createElement(
            Button,
            { icon: React.createElement(ReloadOutlined, null), onClick: handelRefresh },
            t('Refresh'),
          ),
          React.createElement(
            Button,
            { icon: React.createElement(DeleteOutlined, null), onClick: handelBulkDelete },
            t('Delete'),
          ),
          React.createElement(
            Dropdown,
                  ...
                  const drawer = FormDrawer(
                    ...
                    () => {
                      return React.createElement(
                        ...
                        React.createElement(
                          SchemaComponentOptions,
                          { scope: { createOnly: true, t } },
                          React.createElement(SchemaField, { schema: info.key === 'bulk' ? bulkSchema : schema }),
                        ),
                        React.createElement(
                          FormDrawer.Footer,
                          null,
      ...
      React.createElement(EnvironmentVariables, { request: variablesRequest, setSelectRowKeys: setSelectRowKeys }),
    ),
  );
}
//# sourceMappingURL=EnvironmentTabs.js.map

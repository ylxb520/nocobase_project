...
describe('sort field', () => {
    ...
    beforeEach(async () => {
        ...
        db = app.db;
        await app.dataSourceManager.add(new SequelizeDataSource({
            name: 'another',
            collectionManager: {
        ...
        anotherDB = another.collectionManager.db;
    ...
    describe('main data source', () => {
        ...
        it('sort', async () => {
            ...
            await db.sync();
            const test1 = await Test.model.create();
            expect(test1.sort).toBe(1);
            const test2 = await Test.model.create();
            expect(test2.sort).toBe(2);
            const test3 = await Test.model.create();
        ...
        it('skip if sort value not empty', async () => {
            ...
            await db.sync();
            const test1 = await Test.model.create({ sort: 3 });

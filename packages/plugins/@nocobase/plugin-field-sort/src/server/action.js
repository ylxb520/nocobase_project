...
import { BelongsToManyRepository, HasManyRepository, Op } from '@nocobase/database';
import { SortField } from './sort-field';
export async function move(ctx, next) {
    ...
    async sameScopeMove(sourceInstance, targetInstance, options) {
        ...
        await this.collection.repository.update({
            filterByTk: (this.collection.isMultiFilterTargetKey()
                ...
                : sourceInstance.get(this.collection.filterTargetKey)),
            values: {

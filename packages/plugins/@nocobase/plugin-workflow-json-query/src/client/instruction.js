...
function getEngineOptions() {
    return Array.from(engines.getEntities()).reduce((result, [value, options]) => result.concat({ value, ...options }), []);
}
function renderEngineReference(key) {
    ...
    return engine.link ? (React.createElement(React.Fragment, null,
        ...
        React.createElement("a", { href: engine.link, target: "_blank", rel: "noreferrer" }, engine.label))) : null;
}

...
export default class MailerInstruction extends Instruction {
    ...
    async run(node, prevJob, processor) {
        const { provider, contentType, to = [], cc, bcc, subject, html, text, ignoreFail, ...options } = processor.getParsedValue(node.config, node.id);
...
//# sourceMappingURL=MailerInstruction.js.map
...
import { Instruction, WorkflowVariableInput, defaultFieldNames, useAvailableUpstreams, useNodeContext, } from '@nocobase/plugin-workflow/client';
...
function VariableTargetSelect({ value, onChange }) {
    ...
    return (React.createElement("fieldset", null,
        React.createElement(Radio.Group, { value: declaring, onChange: onRadioChange },
            React.createElement(Space, { direction: "vertical" },
                React.createElement(Radio, { value: true }, lang('Declare a new variable')),
                React.createElement(Space, null,
                    React.createElement(Radio, { value: false, disabled: !variables.length }, lang('Assign value to an existing variable')),
                    !declaring && (React.createElement(Select, { options: variables.map((data) => ({
                            label: data.title,
                            value: data.key,
                            data,
                        })), value: value, onChange: onChange, allowClear: true, showSearch: true, filterOption: filterOption })))))));
}
export default class extends Instruction {
    ...
    icon = (React.createElement("span", { className: "anticon", style: {

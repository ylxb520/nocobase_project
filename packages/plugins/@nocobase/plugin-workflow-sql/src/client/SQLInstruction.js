...
export default class extends Instruction {
    ...
    icon = (React.createElement(ConsoleSqlOutlined, { style: {} }));
    fieldset = {
        dataSource: {
            type: 'string',
            required: true,
    ...
    scope = {
        sqlDescription() {
            return (React.createElement(Trans, { ns: NAMESPACE },
                'SQL query result could be used through ',
                React.createElement("a", { href: "https://docs-cn.nocobase.com/handbook/workflow-json-query", target: "_blank", rel: "noreferrer" }, 'JSON query node'),
                ' (Commercial plugin).'));
        },
    };
    components = {

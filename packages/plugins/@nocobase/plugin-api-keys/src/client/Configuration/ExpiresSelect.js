...
const InternalExpiresSelect = (props) => {
  ...
  return React.createElement(
    Space,
    { className: spaceCSS },
    React.createElement(Select, { ...props, value: isCustom ? 'custom' : props.value, onChange: onSelectChange }),
    isCustom
...
const ReadPretty = () => {
  ...
  return React.createElement(Typography.Text, null, expiresDate);
};
...
//# sourceMappingURL=ExpiresSelect.js.map

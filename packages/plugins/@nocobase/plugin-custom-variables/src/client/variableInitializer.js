import { ActionContextProvider, css, parseCollectionName, SchemaComponent, SchemaComponentContext, SchemaInitializer, SchemaInitializerItem, useActionContext, useAPIClient, useCollectionFilterOptions, useCollectionManager_deprecated, useCompile, useVariableScopeInfo, VariableInput, } from '@nocobase/client';
...
function FilterDynamicComponent({ value, onChange, renderSchemaComponent }) {
    return React.createElement(VariableInput, { value: value, onChange: onChange, renderSchemaComponent: renderSchemaComponent });
}
...
const FieldsSelect = observer((props) => {
    ...
    return (React.createElement(Select, { popupMatchSelectWidth: false, ...others, options: fields.filter(filter).map((field) => ({
            label: compile(field.uiSchema?.title),
            value: field.name,
        })) }));
}, { displayName: 'FieldsSelect' });
const getAggregateVariableSchema = (initialValues, action) => {
    const titleMap = {
                ...
                properties: {
                    description: {
                        ...
                        'x-component-props': {
                            ...
                            icon: React.createElement(BarChartOutlined, null),
    ...
    items: [
        {
            ...
            Component: () => {
                ...
                return (React.createElement(React.Fragment, null,
                    React.createElement(SchemaInitializerItem, { title: t('Aggregate variable'), onClick: handleClick }),
                    React.createElement(ActionContextProvider, { value: { visible, setVisible } },
                        React.createElement(SchemaComponentContext.Provider, { value: { designable: false } },
                            React.createElement(SchemaComponent, { schema: getAggregateVariableSchema(undefined, 'create') })))));
            },
        },
    ],
});
export const VariableEditor = ({ visible, setVisible, initialValues }) => {
    return (React.createElement(ActionContextProvider, { value: { visible, setVisible } },
        React.createElement(SchemaComponentContext.Provider, { value: { designable: false } },
            React.createElement(SchemaComponent, { schema: getAggregateVariableSchema(initialValues, 'update') }))));
};
//# sourceMappingURL=variableInitializer.js.map
...
export function relationTypeToString(field) {
  return {
...
export function ListActionTemplate({ collection, relationField }) {
  return {
    get: {
...
export function GetActionTemplate(options) {
...
export function CreateActionTemplate(options) {
  const { collection, relationField } = options;
  return {
    post: {
      tags: [relationField ? `${collection.name}.${relationField.name}` : collection.name],
...
export function UpdateActionTemplate(options) {
  const { collection, relationField } = options;
  return {
    post: {
      tags: [relationField ? `${collection.name}.${relationField.name}` : collection.name],
...
export function DestroyActionTemplate(options) {
  const { collection, relationField } = options;
  return {
    post: {
      tags: [relationField ? `${collection.name}.${relationField.name}` : collection.name],
...
export function MoveActionTemplate(options) {
  const { collection, relationField } = options;
  return {
    post: {
      tags: [relationField ? `${collection.name}.${relationField.name}` : collection.name],

...
import { Instruction, WorkflowVariableJSON, WorkflowVariableRawTextArea, WorkflowVariableTextArea, WorkflowVariableInput, defaultFieldNames, } from '@nocobase/plugin-workflow/client';
...
function BodyComponent(props) {
    ...
    return React.createElement(SchemaComponent, { basePath: f.address, schema: schema, onlyRenderProperties: true });
}
...
//# sourceMappingURL=RequestInstruction.js.map
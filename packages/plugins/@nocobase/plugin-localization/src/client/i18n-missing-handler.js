...
export class MissingKeyHandler {
    ...
    sentMissingKeys = new Set();
    pendingMissingKeys = new Map();
    submitPendingKeysDebounced;
    missingKeyHandler;
    currentLocale;
    constructor(context) {
    ...
    register() {
        ...
        this.missingKeyHandler = (lngs, ns, key) => {

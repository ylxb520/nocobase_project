...
function InternalUsersSelect({ value, onChange, variableOptions }) {
    return (React.createElement(Variable.Input, { scope: variableOptions, value: value, onChange: onChange },
...
function UsersQuery(props) {
    ...
    const FilterDynamicComponent = useCallback(({ value, onChange, renderSchemaComponent }) => {
        return (React.createElement(Variable.Input, { value: value, onChange: onChange, scope: props.variableOptions }, renderSchemaComponent()));

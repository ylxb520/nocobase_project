...
export const MessageConfigForm = observer(({ variableOptions }) => {
    ...
    return (React.createElement(SchemaComponent, { schema: createMessageFormSchema, components: { MessageConfigForm, ArrayItems }, scope: { t } }));

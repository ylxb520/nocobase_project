...
import { SchemaComponent, SchemaComponentContext, useSchemaComponentContext, ExtendCollectionsProvider, } from '@nocobase/client';
    ...
    return (React.createElement(ExtendCollectionsProvider, { collections: [channelCollection, messageLogCollection] },
        React.createElement(SchemaComponentContext.Provider, { value: { ...scCtx, designable: false } },
            React.createElement(Card, { bordered: false },
                React.createElement(SchemaComponent, { schema: messageManagerSchema, scope: { t, [MessageScopeNames.useSendAction]: useSendAction, useSubmitActionProps, useEditFormProps }, components: {

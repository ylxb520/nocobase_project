...
export declare function useNotificationTranslation(): import("react-i18next").UseTranslationResponse<("client" | "data-source-manager" | "notification-manager")[], undefined>;

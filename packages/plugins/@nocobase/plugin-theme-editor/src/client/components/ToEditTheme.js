...
const ToEditTheme = () => {
    ...
    const handleClick = useCallback(() => {
        const m = modal.confirm({
            ...
            maskClosable: true,
            width: 'fit-content',
            footer: (React.createElement(Space, { style: { float: 'right', marginTop: token.margin, justifyContent: 'flex-end' }, wrap: true },
    ...
    return (React.createElement(Button, { type: 'dashed', style: {
            width: 240,
            height: 240,
            borderRadius: token.borderRadiusLG,
            borderColor: 'var(--colorSettings)',
            color: 'var(--colorSettings)',
        }, icon: React.createElement(PlusOutlined, null), onClick: handleClick }, t('Add new theme')));
};
ToEditTheme.displayName = 'ToEditTheme';
export default ToEditTheme;
//# sourceMappingURL=ToEditTheme.js.map
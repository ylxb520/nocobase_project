...
const ThemeEditorContext = React.createContext(null);
...
export const ThemeEditorProvider = ({ children, open, setOpen }) => {
    return React.createElement(ThemeEditorContext.Provider, { value: { open, setOpen } }, children);
};
ThemeEditorProvider.displayName = 'ThemeEditorProvider';
//# sourceMappingURL=ThemeEditorProvider.js.map
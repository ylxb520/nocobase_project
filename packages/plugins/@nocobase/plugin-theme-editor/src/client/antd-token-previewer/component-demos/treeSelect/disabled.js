...
const Demo = () => {
    ...
    return (React.createElement(TreeSelect, { disabled: true, showSearch: true, style: { width: '100%' }, value: value, dropdownStyle: { maxHeight: 400, overflow: 'auto' }, placeholder: "Please select", allowClear: true, treeDefaultExpandAll: true, onChange: onChange },

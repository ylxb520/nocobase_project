...
function onChange() { }
function onSelect() { }
const Demo = () => (React.createElement(Mentions._InternalPanelDoNotUseOrYouWillBeFired, { style: { width: '100%' }, onChange: onChange, onSelect: onSelect, defaultValue: "@afc163" },

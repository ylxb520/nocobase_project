...
const ColorPreview = ({ color, style, className, dark, ...restProps }) => {
    const [warpSSR, hashId] = useStyle();
    return warpSSR(React.createElement("div", { ...restProps, className: classNames('previewer-color-preview', className, hashId), style: {
            // @ts-ignore

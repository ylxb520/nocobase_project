...
const CustomThemeProvider = React.memo((props) => {
    ...
    const editor = (React.createElement("div", { style: { display: 'flex', overflow: 'hidden', height: '100%' } },
        React.createElement("div", { style: contentStyle }, props.children),
        open ? (React.createElement("div", { className: styles.editor },
            React.createElement(CustomTheme, { onThemeChange: setTheme }))) : null));
    ...
    return (React.createElement(ConfigProvider, { theme: theme },
        React.createElement(ThemeListProvider, null,
            React.createElement(InitializeTheme, null,
                React.createElement(ThemeEditorProvider, { open: open, setOpen: setOpen }, editor)))));
});

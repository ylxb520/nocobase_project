    ...
    async up() {
        ...
        await this.db.sequelize.transaction(async (transaction) => {
            for (const item of items) {
                ...
                schema['x-component-props'].action = schema['x-component-props'].action.replace('attachementField', 'attachmentField');
...
//# sourceMappingURL=20230831160742-fix-attachment-field.js.map
...
export const StorageOptions = observer((props) => {
    ...
    return (React.createElement(FormLayout, { layout: 'vertical' },
        React.createElement(RecursionField, { key: form.values.type || 'local', basePath: field.address, onlyRenderProperties: true, schema: s })));
}, { displayName: 'StorageOptions' });
//# sourceMappingURL=StorageOptions.js.map
...
export function validate(file, rules) {
    if (!rules) {
        return null;
    }
...
export function useBeforeUpload(rules) {
    ...
    return useCallback((file, fileList) => {
...
function UploadContent({ model }) {
    ...
    return (React.createElement("div", null,
        React.createElement(Header, { title: ctx.t('Upload file') }),
        React.createElement("div", { style: { height: '50vh' }, onClick: (e) => e.stopPropagation() },
            React.createElement(Upload.Dragger, { multiple: true, listType: 'picture', ...useUploadProps({
                    ...props,
                    handleChange,
                    beforeUpload,
                }) },
                React.createElement("p", { className: `ant-upload-drag-icon` }, loading ? React.createElement(LoadingOutlined, { style: { fontSize: 36 }, spin: true }) : React.createElement(InboxOutlined, null)),
                React.createElement("p", { className: `ant-upload-text` }, ctx.t('Click or drag file to this area to upload')),
                React.createElement("ul", { style: { listStyleType: 'none' } },
                    React.createElement("li", { className: `ant-upload-hint` }, ctx.t('Support for a single or bulk upload.')),
                    React.createElement("li", { className: `ant-upload-hint` }, sizeHint))))));
}
export class UploadActionModel extends ActionModel {
    ...
    render() {
        ...
        const icon = props.icon ? React.createElement(Icon, { type: props.icon }) : undefined;
        return (React.createElement(Button, { ...props, onClick: this.props.onUploadClick, icon: icon }, props.children || props.title));
    }
}
        ...
        openView: {
            ...
            handler(ctx, params) {
                ...
                ctx.viewer.open({
                    ...
                    //   },
                    // },
                    content: () => React.createElement(UploadContent, { model: ctx.model }),
                    styles: {
                        content: {
                            padding: 0,
...
//# sourceMappingURL=UploadActionModel.js.map
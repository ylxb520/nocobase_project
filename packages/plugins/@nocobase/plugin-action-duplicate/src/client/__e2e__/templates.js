 ...
 */
import { general } from '@nocobase/test/e2e';
/**
 * 1. 创建一个名为 general 的 collection，其包含 时间、Percent 类型的字段
 */
export const generalWithDatetimeFields = [
  {
    name: 'general',
    title: 'General',
    fields: [
 ...
 */
export const oneEmptyTableBlockWithDuplicateActions = {
  collections: general,
  pageSchema: {
    _isJSONSchemaObject: true,
    version: '2.0',

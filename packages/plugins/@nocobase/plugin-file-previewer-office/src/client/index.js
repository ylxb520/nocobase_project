...
function OfficeModalPreviewer({ index, list, onSwitchIndex }) {
    ...
    return (React.createElement(Modal, { open: index != null, title: file.title, onCancel: onClose, footer: [
            React.createElement(Button, { key: "open", onClick: onOpen }, t('Open in new window')),
            React.createElement(Button, { key: "download", onClick: onDownload }, t('Download')),
            React.createElement(Button, { key: "close", onClick: onClose }, t('Close')),
...
function OfficeInlinePreviewer({ file }) {
    ...
    return React.createElement("iframe", { src: url, width: "100%", height: "100%", style: { border: 'none' } });
}

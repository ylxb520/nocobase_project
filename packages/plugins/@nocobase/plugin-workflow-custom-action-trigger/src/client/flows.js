...
function CollectionActionWorkflowSelectComponent({ ...props }) {
    ...
    const optionFilter = useCallback(({ config }) => {
    ...
    return React.createElement(TriggerWorkflowSelect, { ...props, optionFilter: optionFilter });
}
        ...
        setContextType: {
            ...
            handler(ctx, params) {
                if (!ctx.model.props.title) {
                    ctx.model.setProps('title', params.type

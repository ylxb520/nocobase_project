...
import { useDataBlockProps, useSchemaInitializer, ModalActionSchemaInitializerItem, } from '@nocobase/client';
...
export const submitToWorkflowActionInitializer = {
...
export const recordTriggerWorkflowActionInitializer = {
    name: 'triggerWorkflow',
    title: `{{t("Trigger workflow", { ns: "${NAMESPACE}" })}}`,
    Component: 'CustomizeActionInitializer',
    schema: {
...
export function DataBlockTriggerWorkflowActionSchemaInitializerItem(props) {
    ...
    return (React.createElement(ModalActionSchemaInitializerItem, { title: t('Trigger workflow', { ns: NAMESPACE }), components: {
            RadioWithTooltip,
        }, modalSchema: {
            title: `{{t("Trigger workflow", { ns: "${NAMESPACE}" })}}`,
            properties: {
                type: {
                    ...
                    'x-component-props': {
                        options: CONTEXT_TYPE_OPTIONS.filter(({ value }) => [CONTEXT_TYPE.GLOBAL, CONTEXT_TYPE.MULTIPLE_RECORDS].includes(value)),
                    },
                    required: true,
                },
            },
...
export function WorkbenchTriggerWorkflowActionSchemaInitializerItem(props) {
    ...
    const { insert } = useSchemaInitializer();
    const { t } = useTranslation();
    return (React.createElement(ModalActionSchemaInitializerItem, { title: t('Trigger workflow', { ns: NAMESPACE }), modalSchema: {
            title: `{{t("Trigger workflow", { ns: "${NAMESPACE}" })}}`,
            properties: {
                title: {
                    title: `{{t('Title')}}`,

...
import { getVariableValue, useAPIClient, useActionContext, useBlockRequestContext, useCollectValuesToSubmit, useCollection, useCollectionRecordData, useCompile, useFilterByTk, useLocalVariables, useVariables, } from '@nocobase/client';
...
export function useGlobalTriggerWorkflowCustomActionProps() {
    ...
    return {
        async onClick(e, callback) {
            ...
            const { manualClose, redirecting, redirectTo: rawRedirectTo, successMessage, actionAfterSuccess, } = onSuccess || {};

...
import { AfterSuccess, AssignedFieldValues, ButtonEditor, joinCollectionName, RemoteSelect, RemoveButton, SchemaSettings, SchemaSettingsActionModalItem, SecondConFirm, SkipValidation, useCollection, useDesignable, useSchemaToolbar, SchemaSettingAccessControl, SchemaSettingsLinkageRules, useCollection_deprecated, RefreshDataBlockRequest, useDataBlockRequestGetter, } from '@nocobase/client';
...
function BindGlobalWorkflowConfig() {
    ...
    return (React.createElement(SchemaSettingsActionModalItem, { title: t('Bind workflows', { ns: 'workflow' }), width: "30%", components: {
            Alert,
            ArrayTable,
            RemoteSelect,
        }, schema: {

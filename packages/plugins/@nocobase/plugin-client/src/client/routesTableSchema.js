...
export const createRoutesTableSchema = (collectionName, basename) => {
                    ...
                    properties: {
                      type: {
                        ...
                        'x-component': (props) => {
                          ...
                          return React.createElement(
                            ...
                            { ...props },
                            !isMobile &&
                              React.createElement(Radio, { value: NocoBaseDesktopRouteType.group }, t('Group')),
                            React.createElement(
                              Radio,
                            ...
                            React.createElement(Radio, { value: NocoBaseDesktopRouteType.link }, t('Link')),
                          );
                        },
                      ...
                      hideInMenu: {
                        ...
                        'x-component': (props) => {
                          ...
                          return React.createElement(Checkbox, { checked: checked, onChange: onChange });
                        },
                        default: false,
                      },
                      enableTabs: {
                        ...
                        'x-component': (props) => {
                          return React.createElement(Checkbox, { checked: props.value, onChange: props.onChange });
                        },
                        'x-reactions': {
                          dependencies: ['type'],
                          fulfill: {
            ...
            properties: {
              title: {
                ...
                'x-component': function Com(props) {
                  ...
                  return React.createElement(CollectionField, { ...props, value: t(value) });
                },
                'x-read-pretty': true,
                'x-component-props': {
                  ellipsis: true,
          ...
          type: {
            ...
            properties: {
              type: {
                type: 'string',
                'x-component': (props) => {
                  return React.createElement(TypeTag, { value: props.value });
                },
                'x-read-pretty': true,
                'x-component-props': {
                  ellipsis: true,
          ...
          hideInMenu: {
            ...
            properties: {
              hideInMenu: {
                ...
                'x-component': (props) => {
                  return props.value
                    ? React.createElement(CloseOutlined, { style: { color: '#ff4d4f' } })
                    : React.createElement(CheckOutlined, { style: { color: '#52c41a' } });
                },
                'x-read-pretty': true,
                'x-component-props': {
                  ellipsis: true,
                ...
                'x-component': function Com() {
                  ...
                  if (
                    ...
                    return React.createElement(
                      ...
                      { copyable: true, style: { marginBottom: 0 }, ellipsis: true },
                      path,
                    );
                  }
                  ...
                  return React.createElement(Tag, null, t('Unknown'), ' ');
                },
                'x-read-pretty': true,
              },
            },
                            ...
                            'x-component': (props) => {
                              ...
                              return React.createElement(
                                ...
                                !isMobile &&
                                  React.createElement(
                                    Radio,
                                    { value: NocoBaseDesktopRouteType.group, disabled: !isGroup },
                                    t('Group'),
                                  ),
                                React.createElement(
                                  Radio,
                                  { value: NocoBaseDesktopRouteType.page, disabled: !isGroup },
                                  t(isMobile ? 'Page' : 'Classic page (v1)'),
                                ),
                                !isMobile &&
                                  React.createElement(
                                    Radio,
                                    { value: NocoBaseDesktopRouteType.flowPage, disabled: !isGroup },
                                    t('Modern page (v2)'),
                                  ),
                                React.createElement(
                                  Radio,
                                  { value: NocoBaseDesktopRouteType.link, disabled: !isGroup },
                                  t('Link'),
                                ),
                                React.createElement(
                                  Radio,
                                  { value: NocoBaseDesktopRouteType.tabs, disabled: !isPage },
                                  t('Tab'),
                                ),
                              );
                            },
...
function useCreateRouteSchema(isMobile) {
  ...
  const createTabRouteSchema = useCallback(
    async ({ title, icon, parentSchemaUid }) => {
...
function TypeTag(props) {
  ...
  return React.createElement(Tag, { color: colorMap[props.value] }, valueMap[props.value]);
}
...
// copy from @nocobase/plugin-mobile/client
// TODO: 需要把相关代码移动到 @nocobase/plugin-mobile
function getMobilePageSchema(pageSchemaUid, firstTabUid) {
  const pageSchema = {
    type: 'void',
    name: pageSchemaUid,
    'x-uid': pageSchemaUid,
...
// copy from @nocobase/plugin-mobile/client
// TODO: 需要把相关代码移动到 @nocobase/plugin-mobile
function getPageContentTabSchema(pageSchemaUid) {
  return {
    type: 'void',
    'x-uid': pageSchemaUid,
    'x-async': true,
...
//# sourceMappingURL=routesTableSchema.js.map

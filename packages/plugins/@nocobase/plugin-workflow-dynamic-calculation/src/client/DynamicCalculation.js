...
import { Variable, useCollectionManager_deprecated } from '@nocobase/client';
import { BaseTypeSets, Instruction, ValueBlock, WorkflowVariableInput, defaultFieldNames, useWorkflowVariableOptions, } from '@nocobase/plugin-workflow/client';
...
function DynamicExpression({ value, onChange }) {
    ...
    return React.createElement(Variable.Input, { value: value, onChange: onChange, scope: scope });
}
export default class extends Instruction {
    ...
    icon = (React.createElement(FunctionOutlined, null));
    fieldset = {
        expression: {
            type: 'string',

...
export class ExpressionCollectionTemplate extends CollectionTemplate {
    ...
    configurableProperties = getConfigurableProperties('title', 'name', 'inherits', 'category', 'description', 'presetFields');
}
//# sourceMappingURL=ExpressionCollectionTemplate.js.map
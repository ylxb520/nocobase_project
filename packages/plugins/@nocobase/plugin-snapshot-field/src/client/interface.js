...
import { CollectionFieldInterface, interfacesProperties, useCollectionManager_deprecated, useRecord, } from '@nocobase/client';
...
const onTargetFieldChange = (field) => {
    field.value; // for watch
    const targetField = field.query(`.${APPENDS}`).take();

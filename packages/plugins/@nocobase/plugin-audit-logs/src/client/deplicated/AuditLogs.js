...
const Username = observer(
  () => {
    ...
    return React.createElement('div', null, field?.value?.nickname || field.value?.id);
  },
...
const Collection = observer(
  () => {
    ...
    return React.createElement('div', null, title ? compile(title) : name);
  },
...
const Value = observer(
  () => {
    ...
    return React.createElement('div', null, field.value ? JSON.stringify(field.value) : null);
  },
  { displayName: 'Value' },
);
  ...
  (props) => {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(TableBlockProvider, { ...defaults }, props.children),
      ),
    );
  },

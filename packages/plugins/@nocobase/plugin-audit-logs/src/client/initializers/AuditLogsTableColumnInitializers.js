...
const ParentCollectionFields = () => {
  ...
  return React.createElement(SchemaInitializerChildren, null, res);
};
const AssociatedFields = () => {
  ...
  return React.createElement(SchemaInitializerChildren, null, schema);
};
const commonOptions = {
...
//# sourceMappingURL=AuditLogsTableColumnInitializers.js.map

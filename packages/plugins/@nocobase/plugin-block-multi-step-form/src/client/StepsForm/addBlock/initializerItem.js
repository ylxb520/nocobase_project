...
import { useCollection, useSchemaInitializer, useCollectionManager, useCollectionField } from '@nocobase/client';
import React from 'react';
import { ComponentType } from '../../constants';
import { useT } from '../../locale';
import { getStepsFormSchema } from './blockSchema';
export const stepsFormInitializerItemCreater = (from, formType) => {
  return {
    name: ComponentType,
    ...
    useComponentProps() {
      ...
      const itemConfig = {
        icon: React.createElement(FormOutlined, null),
...
//# sourceMappingURL=initializerItem.js.map

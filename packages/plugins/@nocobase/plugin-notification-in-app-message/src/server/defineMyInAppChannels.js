            ...
            list: {
                handler: async (ctx) => {
                    ...
                    const messagesFieldName = {
                        ...
                        receiveTimestamp: messagesCollection.getRealFieldName(MessagesDefinition.fieldNameMap.receiveTimestamp, true),
              ...
              AND messages.${messagesFieldName.userId} = ${userId}
                    ...
                    const channelStatusFilter = filter.status === 'all' || !filter.status
                        ? null
...
//# sourceMappingURL=defineMyInAppChannels.js.map
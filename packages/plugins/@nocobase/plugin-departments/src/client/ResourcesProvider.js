...
export const DepartmentsListProvider = (props) => {
  const { departmentsResource } = useContext(ResourcesContext);
  const { service } = departmentsResource || {};
  return React.createElement(
    ResourceActionContext.Provider,
    { value: { ...service } },
    React.createElement(CollectionProvider_deprecated, { collection: departmentCollection }, props.children),
  );
};
export const UsersListProvider = (props) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      { value: { service, field } },
      React.createElement(CollectionProvider_deprecated, { collection: userCollection }, props.children),
    ),
  );
};
//# sourceMappingURL=ResourcesProvider.js.map

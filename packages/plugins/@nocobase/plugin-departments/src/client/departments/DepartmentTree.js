...
export const DepartmentTree = () => {
  ...
  return React.createElement(
    ...
    treeData?.length
      ? React.createElement(Tree.DirectoryTree, {
          loadData: loadData,
          treeData: treeData,
...
DepartmentTree.Item = function DepartmentTreeItem({ node, setVisible, setDrawer }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('div', { style: { marginLeft: '15px' } }, React.createElement(MoreOutlined, null)),
    ),
  );
};
//# sourceMappingURL=DepartmentTree.js.map

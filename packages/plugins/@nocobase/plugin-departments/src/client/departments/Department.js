...
export const DepartmentTreeContext = createContext({});
...
export const Department = () => {
  ...
  const departmentManager = useDepartmentManager({
    label: ({ node }) =>
      React.createElement(DepartmentTree.Item, { node: node, setVisible: setVisible, setDrawer: setDrawer }),
  });
  return React.createElement(
    SchemaComponentOptions,
    { scope: { useCreateDepartment, useUpdateDepartment } },
    React.createElement(
      ...
      React.createElement(
        Row,
        null,
        React.createElement(AggregateSearch, null),
        React.createElement(
          Button,
          {
            type: 'text',
        ...
        React.createElement(NewDepartment, null),
      ),
      React.createElement(Divider, { style: { margin: '12px 0' } }),
      React.createElement(DepartmentTree, null),
      React.createElement(
        ActionContextProvider,
        ...
        React.createElement(
          RecordProvider,
          { record: drawer.node || {} },
          React.createElement(SchemaComponent, { scope: { t }, schema: drawer.schema || {} }),
        ),
      ),
    ),
  );

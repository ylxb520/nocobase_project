...
export const OverrideFieldAction = ({ item: record, parentItem: parentRecord }) => {
    return (React.createElement(OverridingCollectionFieldAction, { item: { ...record }, parentItem: parentRecord, scope: {
            useCancelAction,
            useOverridingCollectionField: () => useOverridingCollectionField(record),
        }, getContainer: getPopupContainer },
        React.createElement(CopyOutlined, { className: "btn-override" })));
};
//# sourceMappingURL=OverrideFieldAction.js.map
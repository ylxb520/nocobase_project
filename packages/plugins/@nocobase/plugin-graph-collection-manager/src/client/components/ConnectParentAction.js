...
export const ConnectParentAction = (props) => {
    ...
    return isShowParent ? (React.createElement(Tooltip, { title: t('Show parent'), getPopupContainer: getPopupContainer },
        React.createElement(RiseOutlined, { className: "btn-inheriedParent", onClick: () => {
                targetGraph.onConnectionParents(parents);
            } }))) : ('');
};
//# sourceMappingURL=ConnectParentAction.js.map
...
export const ConnectChildAction = (props) => {
    ...
    return isShowChild ? (React.createElement(Tooltip, { title: t('Show child'), getPopupContainer: getPopupContainer },
        React.createElement(FallOutlined, { className: "btn-inheriedChild", onClick: () => {
                targetGraph.onConnectionChilds(childs.map((v) => v.name));
            } }))) : ('');
};
//# sourceMappingURL=ConnectChildAction.js.map
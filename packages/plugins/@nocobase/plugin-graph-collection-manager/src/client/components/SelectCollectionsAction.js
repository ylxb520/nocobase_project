...
export const SelectCollectionsAction = (props) => {
    ...
    return (React.createElement(Select, { value: data, showSearch: true, getPopupContainer: getPopupContainer, mode: "multiple", allowClear: true, options: collectionOptions, onChange: handleChange, style: { minWidth: 200, position: 'fixed', margin: '24px', zIndex: 1000, maxWidth: '60%' } }));
};
//# sourceMappingURL=SelectCollectionsAction.js.map
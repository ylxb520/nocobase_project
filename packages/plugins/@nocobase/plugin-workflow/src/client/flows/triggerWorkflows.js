 ...
 */
import { FormSubmitActionModel, UpdateRecordActionModel, joinCollectionName, } from '@nocobase/client';
import { NAMESPACE } from '../locale';
import { TriggerWorkflowSelect } from '../components';
export function createTriggerWorkflowsSchema({ WorkflowSelectComponent = TriggerWorkflowSelect, optionFilter, usingContext = true, filter, } = {}) {
    return (ctx) => {
        const { collection: collectionModel } = ctx.blockModel;
...
//# sourceMappingURL=triggerWorkflows.js.map
        ...
        triggerFieldset: {
            date: {
                ...
                'x-component-props': {
                    ...
                    changeOnSelect: true,
                    render(props) {
                        return (React.createElement(DatePicker, { showTime: true, placeholder: lang('Current time'), ...props, value: dayjs(props.value || new Date()) }));
                    },
                },
            },
        },
...
//# sourceMappingURL=ScheduleModes.js.map
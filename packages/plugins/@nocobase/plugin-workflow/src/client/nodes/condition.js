...
export default class extends Instruction {
    ...
    Component({ data }) {
        ...
        return (React.createElement(NodeDefaultView, { data: data }, rejectOnFalse ? null : (React.createElement("div", { className: styles.nodeSubtreeClass },
            React.createElement("div", { className: styles.branchBlockClass },
                React.createElement(Branch, { from: data, entry: falseEntry, branchIndex: 0 }),
                React.createElement(Branch, { from: data, entry: trueEntry, branchIndex: 1 })),
            React.createElement("div", { className: styles.conditionClass },
                React.createElement("span", { style: { right: '4em' } }, t('No')),
                React.createElement("span", { style: { left: '4em' } }, t('Yes')))))));
    }
    testable = true;
}

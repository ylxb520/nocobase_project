...
import { SchemaComponentContext, parseCollectionName, useApp, useCollectionDataSource, useCompile, } from '@nocobase/client';
...
export default class extends Instruction {
    ...
    icon = (React.createElement(FileSearchOutlined, { style: {} }));
    fieldset = {
        collection: {
            ...collection,

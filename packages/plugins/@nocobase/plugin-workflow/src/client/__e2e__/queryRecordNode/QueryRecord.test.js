...
test('Collection event add data trigger, filter to meet all conditions (status_singleselect=1 and staffnum>20) unsorted, query normal table 1 record', async ({ page, mockCollections, mockRecords, }) => {
    ...
    await mockCollections(appendJsonCollectionName(JSON.parse(JSON.stringify(generalWithNoRelationalFields)), queryNodeAppendText)
        .collections);
...
//# sourceMappingURL=QueryRecord.test.js.map
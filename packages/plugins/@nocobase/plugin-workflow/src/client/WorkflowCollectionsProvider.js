...
export function WorkflowCollectionsProvider(props) {
    return (React.createElement(ExtendCollectionsProvider, { collections: [workflows, flow_nodes, executions, workflowCategories] }, props.children));
}
//# sourceMappingURL=WorkflowCollectionsProvider.js.map
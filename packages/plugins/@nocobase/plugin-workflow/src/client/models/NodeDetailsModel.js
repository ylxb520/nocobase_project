 ...
 */
import { CollectionBlockModel, FormComponent } from '@nocobase/client';
import { createCurrentRecordMetaFactory, createRecordResolveOnServerWithLocal, FlowModelRenderer, SingleRecordResource, tExpr, } from '@nocobase/flow-engine';
...
export class NodeDetailsModel extends CollectionBlockModel {
    ...
    createResource(ctx, params) {
        ...
        resource.refresh = noop;
        return resource;
    }
    onInit(options) {
        super.onInit(options);
        const recordMeta = createCurrentRecordMetaFactory(this.context, () => this.collection);
        this.context.defineProperty('record', {
            get: () => this.getCurrentRecord(),
            cache: false,
            resolveOnServer: createRecordResolveOnServerWithLocal(() => this.collection, () => this.getCurrentRecord()),
            meta: recordMeta,
        });
    }
    getCurrentRecord() {
    ...
    renderComponent() {
        ...
        return (React.createElement(FormComponent, { model: this, layoutProps: { colon, labelAlign, labelWidth, labelWrap, layout } },
            React.createElement(FlowModelRenderer, { model: this.subModels.grid, showFlowSettings: false })));
    }
}
...
//# sourceMappingURL=NodeDetailsModel.js.map
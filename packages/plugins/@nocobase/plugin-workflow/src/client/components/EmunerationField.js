...
export function EnumerationField(props) {
    ...
    return items.map((item) => {
        return (React.createElement(Tag, { key: item[fieldNames.value], color: item[fieldNames.color] }, compile(item[fieldNames.label])));
    });
}
//# sourceMappingURL=EmunerationField.js.map
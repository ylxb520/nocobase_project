...
function NotificationAddition() {
    ...
    const onAddSelect = useCallback((value) => {
    ...
    return disabled ? null : (React.createElement(Select, { value: null, placeholder: lang('Add channel'), fieldNames: {
            label: 'title',
            value: 'name',
        }, options: options, onChange: onAddSelect, style: {
            width: '12em',
        } }));
}
...
function ChannelsContextProvider(props) {
    ...
    if (loading) {
        return React.createElement(LoadingOutlined, { spin: true });
    }
    return React.createElement(ChannelsContext.Provider, { value: options }, props.children);
}
...
export default function ({ type }) {
    ...
    return (React.createElement(ChannelsContextProvider, null,
...
//# sourceMappingURL=NotificationFieldset.js.map
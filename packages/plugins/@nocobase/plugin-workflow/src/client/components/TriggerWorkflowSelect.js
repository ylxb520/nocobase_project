...
import { joinCollectionName, useCompile, usePlugin, DataSourceProvider, RemoteSelect, parseCollectionName, } from '@nocobase/client';
        ...
        onFieldValueChange(`group[${index}].context`, (field) => {
            ...
            if (field.value) {
                ...
                for (let i = 0; i < paths.length && collection; i++) {
                    ...
                    if (associationField) {
                        collection = props.collection?.dataSource.collectionManager.getCollection(associationField.target, dataSourceKey);
                    }
                }
            }
...
//# sourceMappingURL=TriggerWorkflowSelect.js.map
...
export function FilterDynamicComponent({ value, onChange, renderSchemaComponent }) {
    ...
    return (React.createElement(Variable.Input, { value: value, onChange: onChange, scope: scope }, renderSchemaComponent()));
}
//# sourceMappingURL=FilterDynamicComponent.js.map
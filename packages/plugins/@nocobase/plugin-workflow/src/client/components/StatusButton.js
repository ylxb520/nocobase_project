...
export function StatusButton(props) {
    ...
    if (typeof status !== 'undefined' && statusMap?.[status]) {
        ...
        tag = React.createElement(Tag, { color: color }, icon);
    }
    return (React.createElement(Button, { ...others, shape: "circle", size: "small", className: classnames(tag ? styles.statusButtonClass : styles.noStatusButtonClass, props.className) }, tag));
}

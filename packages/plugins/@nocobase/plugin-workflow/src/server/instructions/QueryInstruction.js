...
export class QueryInstruction extends Instruction {
    async run(node, input, processor) {
        ...
        const { page = DEFAULT_PAGE, pageSize = DEFAULT_PER_PAGE, sort = [], ...options } = processor.getParsedValue(params, node.id);
        const appends = options.appends
            ? Array.from(options.appends.reduce((set, field) => {
...
//# sourceMappingURL=QueryInstruction.js.map
...
describe('workflow > cluster', () => {
    ...
    describe('event queue', () => {
        ...
        it.skipIf(process.env['DB_DIALECT'] == 'sqlite')('should be able to process executions on other nodes', async () => {
            const [app1, app2, app3] = cluster.nodes;
            const p1 = app1.pm.get(Plugin);
            const p2 = app2.pm.get(Plugin);

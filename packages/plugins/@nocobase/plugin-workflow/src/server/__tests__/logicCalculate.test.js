 ...
 */
import { logicCalculate, calculators } from '../logicCalculate';
describe('workflow > logic calculate', () => {
    ...
    it('should throw error for unregistered calculator', () => {
        expect(() => logicCalculate({ calculator: 'foo', operands: [1, 1] })).toThrow('no calculator function registered for "foo"');
    });
...
//# sourceMappingURL=logicCalculate.test.js.map
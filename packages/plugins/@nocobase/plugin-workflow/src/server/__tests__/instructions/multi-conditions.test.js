...
describe('workflow > instructions > multi-conditions', () => {
    ...
    beforeEach(async () => {
        app = await getApp();
        plugin = app.pm.get(WorkflowPlugin);
        db = app.db;
    ...
    async function createBranch(node, branchIndex, options = {}) {
    ...
    async function waitForExecution(execution, predicate, timeout = 1000) {
...
//# sourceMappingURL=multi-conditions.test.js.map
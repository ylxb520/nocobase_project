        ...
        label: React.createElement(() => {
            ...
            return (React.createElement("div", null,
                ...
                React.createElement(Tooltip, { title: React.createElement("div", null,
                        ...
                        ' ',
                        React.createElement("a", { href: `https://${isSimplifiedChinese ? 'docs-cn' : 'docs'}.nocobase.com/handbook/multi-keyword-filter`, target: "_blank", rel: "noopener noreferrer" },
...
export class PluginFilterOperatorMultipleKeywordsClient extends Plugin {
    ...
    async load() {
        ['input', 'phone', 'email', 'uuid', 'sequence', 'integer', 'number', 'percent', 'nanoid'].forEach((interfaceName) => {

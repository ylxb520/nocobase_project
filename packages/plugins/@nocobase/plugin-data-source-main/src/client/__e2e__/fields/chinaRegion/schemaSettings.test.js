    ...
    test('set default value', async ({ page, mockPage }) => {
        await testDefaultValue({
            ...
            expectConstantValue: async () => {
                await expect(page.getByLabel('block-item-CollectionField-general-form-general.chinaRegion-chinaRegion')).toHaveText('chinaRegion:北京市/市辖区/东城区');
            },
        });
    });
        ...
        await testPattern({
            ...
            expectReadonly: async () => {
                await expect(page
                    .getByLabel('block-item-CollectionField-general-form-general.chinaRegion-chinaRegion')
                    .locator('.ant-select')
                    .getByRole('combobox')).toBeDisabled();
            },
            expectEasyReading: async () => {
                await expect(page
                    .getByLabel('block-item-CollectionField-general-form-general.chinaRegion-chinaRegion')
                    .locator('.ant-select')
                    .getByRole('combobox')).not.toBeVisible();
                await expect(page.getByLabel('block-item-CollectionField-general-form-general.chinaRegion-chinaRegion')).toHaveText('chinaRegion:北京市 / 市辖区 / 东城区');
            },
        });
    });

 ...
 */
import { expect, expectSettingsMenu, oneTableBlockWithAddNewAndViewAndEditAndMediaFields, test, } from '@nocobase/test/e2e';
        ...
        await testPattern({
            ...
            expectEditable: async () => {
                await expect(page
                    ...
                    .locator('.ant-upload-select')).toBeVisible();
            },
    ...
    test('pattern', async ({ page, mockPage, mockRecord }) => {
        ...
        await testPattern({
            ...
            expectReadonly: async () => {
                ...
                await expect(page
                    .getByLabel('block-item-CollectionField-general-form-general.attachment-attachment')
                    .getByRole('button', { name: 'delete' })).not.toBeVisible();
            },
            expectEasyReading: async () => {
                await page
                    .getByLabel('block-item-CollectionField-general-form-general.attachment-attachment')

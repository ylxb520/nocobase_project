    ...
    test('pattern', async ({ page, mockPage, mockRecords }) => {
        ...
        await testPattern({
            ...
            expectEasyReading: async () => {
                await expect(page.getByLabel('block-item-CollectionField-general-form-general.oneToOneBelongsTo-oneToOneBelongsTo')).toHaveText(`oneToOneBelongsTo:${String(records[0].id)}`);
            },
        });
    });
...
//# sourceMappingURL=schemaSettings1.test.js.map
 ...
 */
import { parseCollectionName, RemoteSelect, useCollectionDataSource, useCompile, } from '@nocobase/client';
import { Trigger, CollectionBlockInitializer, FieldsSelect, getCollectionFieldOptions, RadioWithTooltip, CheckboxGroupWithTooltip, useGetDataSourceCollectionManager, TriggerCollectionRecordSelect, WorkflowVariableWrapper, } from '@nocobase/plugin-workflow/client';
    ...
    triggerFieldset = {
        ...
        userId: {
            ...
            'x-component-props': {
                ...
                render(props) {
                    return (React.createElement(RemoteSelect, { fieldNames: { label: 'nickname', value: 'id' }, service: { resource: 'users' }, manual: false, ...props }));
                },
            },
            default: null,
            required: true,
        ...
        roleName: {
            ...
            'x-component-props': {
                ...
                render(props) {
                    return (React.createElement(RemoteSelect, { fieldNames: { label: 'title', value: 'name' }, service: { resource: 'roles' }, manual: false, ...props }));
                },
            },
            default: null,
        },
...
//# sourceMappingURL=RequestInterceptionTrigger.js.map
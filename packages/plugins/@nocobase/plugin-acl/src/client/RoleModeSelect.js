...
import { Flex, message, Select, Tooltip } from 'antd';
  ...
  return React.createElement(
    ...
    React.createElement(Select, {
      ...
      optionRender: (option) =>
        React.createElement(
          Tooltip,
          { placement: 'right', title: React.createElement('div', null, option.data.desc) },
          React.createElement(
            Flex,
            { justify: 'space-between' },
            React.createElement('span', { style: { display: 'inline-flex', paddingRight: 8 } }, option.data.label),
          ),
        ),
    }),
  );
};
//# sourceMappingURL=RoleModeSelect.js.map

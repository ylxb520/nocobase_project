...
export const progressWithByParams = (taskX1, taskX2, progress, rtl) => {
 ...
 */
export const handleTaskBySVGMouseEvent = (svgX, action, selectedTask, xStep, timeStep, initEventX1Delta, rtl) => {
    let result;
...
//# sourceMappingURL=bar-helper.js.map
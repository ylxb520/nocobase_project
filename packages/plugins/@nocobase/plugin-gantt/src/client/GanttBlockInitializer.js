...
import { DataBlockInitializer, FormDialog, SchemaComponent, SchemaComponentOptions, useCollectionManager_deprecated, useGlobalTheme, useSchemaInitializer, useSchemaInitializerItem, } from '@nocobase/client';
import { createGanttBlockUISchema } from './createGanttBlockUISchema';
export const GanttBlockInitializer = ({ filterCollections, onlyCurrentDataSource, hideSearch, createBlockSchema, showAssociationFields, }) => {
    const itemConfig = useSchemaInitializerItem();
    const { createGanttBlock } = useCreateGanttBlock();
    return (React.createElement(DataBlockInitializer, { ...itemConfig, componentType: `Gantt`, icon: React.createElement(ProjectOutlined, { rotate: 90 }), onCreateBlockSchema: async (options) => {
...
export const useCreateGanttBlock = () => {
    ...
    const createGanttBlock = async ({ item }) => {
        ...
        insert(createGanttBlockUISchema({
...
//# sourceMappingURL=GanttBlockInitializer.js.map
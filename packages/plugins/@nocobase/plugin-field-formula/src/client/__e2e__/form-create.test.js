...
test('formula field calculation', async ({ page, mockPage }) => {
    ...
    await page
        ...
        .getByRole('spinbutton')
        .fill('3');
    await expect(page.getByLabel('block-item-CollectionField-general-form-general.formula-formula')).toHaveText('formula:6');
});
//# sourceMappingURL=form-create.test.js.map
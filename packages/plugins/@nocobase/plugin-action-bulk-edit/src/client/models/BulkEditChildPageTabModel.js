...
function PageTabChildrenRenderer({ ctx, options }) {
  ...
  return React.createElement(FlowModelRenderer, {
    model: data,
    fallback: React.createElement(SkeletonFallback, { style: { margin } }),
  });
}
...
export class BulkEditChildPageTabModel extends ChildPageTabModel {
  renderChildren() {
    return React.createElement(PageTabChildrenRenderer, {
      ctx: this.context,
      options: {
        parentId: this.uid,
        subKey: 'grid',
...
//# sourceMappingURL=BulkEditChildPageTabModel.js.map

...
import { CompatibleSchemaInitializer, SchemaInitializerOpenModeSchemaItems, createDesignable, useAPIClient, useAssociatedFormItemInitializerFields, useDesignable, useFormItemInitializerFields, useGetAriaLabelOfDesigner, useOpenModeContext, useSchemaInitializerRender, ParentCollectionFields, } from '@nocobase/client';
...
export const KanbanCardDesigner = () => {
    ...
    return (React.createElement("div", { className: 'general-schema-designer' },
        React.createElement("div", { className: 'general-schema-designer-icons' },
            React.createElement(Space, { size: 2, align: 'center' }, render()))));
};
const commonOptions = {
    wrap: gridRowColWrap,
    useInsert() {
    ...
    Component: (props) => {
        ...
        return (React.createElement(MenuOutlined, { ...props, role: "button", "aria-label": getAriaLabel('schema-initializer'), style: { cursor: 'pointer', fontSize: 12 } }));
    },
    items: [
        {
            type: 'itemGroup',
...
//# sourceMappingURL=Kanban.Card.Designer.js.map
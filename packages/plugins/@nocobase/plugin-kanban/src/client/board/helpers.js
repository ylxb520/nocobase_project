 ...
 */
import { addInArrayAtPosition, changeElementOfPositionInArray, removeFromArrayAtPosition, replaceElementOfArray, } from './utils';
...
function changeCard(board, cardId, newCard) {
    const changedCards = (cards) => replaceElementOfArray(cards)({
        when: ({ id }) => id === cardId,

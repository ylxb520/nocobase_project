...
function withDroppable(Component) {
    const res = function WrapperComponent({ children, ...droppableProps }) {
        return (React.createElement(Droppable, { ...droppableProps }, (provided) => (React.createElement(Component, { ref: provided.innerRef, ...provided.droppableProps },
            children,
...
//# sourceMappingURL=withDroppable.js.map
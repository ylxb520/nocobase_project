...
import { KanbanBlockInitializer, useCreateAssociationKanbanBlock, useCreateKanbanBlock, } from './KanbanBlockInitializer';
...
const KanbanPluginProvider = React.memo((props) => {
    return (React.createElement(SchemaComponentOptions, { components: { Kanban, KanbanBlockProvider, KanbanV2, KanbanBlockInitializer }, scope: { useKanbanBlockProps } }, props.children));
});
...
class PluginKanbanClient extends Plugin {
    ...
    registerGroupFieldInterface(interfaceName, options) {

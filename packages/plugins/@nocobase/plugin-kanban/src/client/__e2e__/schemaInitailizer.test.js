...
test.describe('configure fields', () => {
    test('configure normal field', async ({ page, mockPage, mockRecord }) => {
        ...
        await expect(page.getByLabel('block-item-CollectionField-general-kanban-general.singleLineText')).toHaveText(/singleLineText/);
...
//# sourceMappingURL=schemaInitailizer.test.js.map
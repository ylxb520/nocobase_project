...
test.describe('kanban: open popup via URL', () => {
    test('basic', async ({ page, mockPage, mockRecords }) => {
        ...
        await expect(page.getByTestId('drawer-Action.Container-kanban-View record').getByLabel('block-item-CollectionField-')).toHaveText('Single select:Option1');
        ...
        await expect(page.getByTestId('drawer-Action.Container-kanban-Edit record').getByLabel('block-item-CollectionField-')).toHaveText('Single select:Option1');
        ...
        await expect(page.getByLabel('block-item-CollectionField-kanban-details-kanban.select-Single select')).toHaveText('Single select:Option2');

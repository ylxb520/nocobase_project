...
export const PageDesigner = (props) => {
    ...
    return (React.createElement(SchemaSettingsDropdown, { title: React.createElement(Button, { style: {
                ...
                width: '100%',
            }, icon: React.createElement(MenuOutlined, null), type: "dashed" }, t('Page configuration')), ...schemaSettingsProps },
        React.createElement(SchemaSettingsSwitchItem, { checked: isHeaderEnabled, title: t('Enable Header'), onChange: async (v) => {
                if (!headerSchema) {
        ...
        React.createElement(SchemaSettingsSwitchItem, { checked: isTabsEnabled, title: t('Enable Tabs'), onChange: async (v) => {
                if (!tabsSchema) {

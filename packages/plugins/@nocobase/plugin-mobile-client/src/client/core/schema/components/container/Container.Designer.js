...
export const ContainerDesigner = () => {
    ...
    return (React.createElement(SchemaSettingsDropdown, { title: React.createElement(Button, { style: {
                ...
                width: '100%',
            }, icon: React.createElement(MenuOutlined, null), type: "dashed" }, t('App level Configuration')), ...schemaSettingsProps },
        React.createElement(SchemaSettingsSwitchItem, { checked: tabBarEnabled, title: t('Enable TabBar'), onChange: async (v) => {
                if (v) {
                    if (!tabBarSchema) {
...
//# sourceMappingURL=Container.Designer.js.map
 ...
 */
import { createRouterManager, Plugin, RouteSchemaComponent } from '@nocobase/client';
...
const { AppConfiguration, InterfaceConfiguration } = lazy(() => import('./configuration'), 'AppConfiguration', 'InterfaceConfiguration');
...
export class PluginMobileClient extends Plugin {
    ...
    setMobileRouter() {
        ...
        router.add('root', {
            path: '/',
            element: React.createElement(Navigate, { replace: true, to: "/mobile" }),
        });
        router.add('mobile', {
            path: '/mobile',
            element: React.createElement(MApplication, null),
        });
        router.add('mobile.page', {
            path: '/mobile/:name',
            element: React.createElement(RouteSchemaComponent, null),
        });

    ...
    return {
        async run() {
            try {
                ...
                const bodyField = form.query('body').take();
...
export const ParsingJson = () => {
    return (React.createElement(SchemaComponent, { components: { NInput, Flex, Button }, scope: { ParseJsonAction, ClearItemsAction }, schema: {
            type: 'void',
            'x-component': 'div',
            properties: {
                json: {
                ...
                parseArray: {
                    ...
                    description: lang('If the JSON object contains array items, parse them. eg: { "arrayKey": [ "item1", "item2" ] will be parsed as "arrayKey", "arrayKey.0", "arrayKey.1", if set to false, only "arrayKey" will be parsed.'),
                    'x-decorator': 'FormItem',
                    'x-decorator-props': {
                    // layout: 'horizontal',
                    },
...
//# sourceMappingURL=ParsingJSON.js.map
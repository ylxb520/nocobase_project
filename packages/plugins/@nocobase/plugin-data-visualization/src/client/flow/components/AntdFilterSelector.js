 ...
 */
export const AntdFilterSelector = ({
  value,
  onChange,
  model,
  ...
  React.useEffect(() => {
    ...
    if (!isEqual(current, next)) {
      ...
      internalRef.current.items = next.items;
    }
  }, [value]);
  ...
  const renderFilterItem = React.useCallback(
    (p) => React.createElement(VariableFilterItem, { ...p, model: model, rightAsVariable: rightAsVariable }),
  ...
  return React.createElement(
    ...
    React.createElement(FilterGroup, {
      ...
      FilterItem: renderFilterItem,
      closeIcon: React.createElement(DeleteOutlined, null),
    }),
  );
};
AntdFilterSelector.displayName = 'AntdFilterSelector';
export default AntdFilterSelector;
//# sourceMappingURL=AntdFilterSelector.js.map

...
export const BlockRefreshButton = forwardRef((props, ref) => {
  ...
  const items = Object.entries(interval).map(([key, label]) => ({
    key,
    label,
  ...
  return React.createElement(
    Dropdown.Button,
    {
      ...
      buttonsRender: ([_, rightButton]) => [
        _,
        React.cloneElement(rightButton, { iconPosition: 'end' }, autoRefresh ? interval[autoRefresh] : null),
      ],
    },
...
//# sourceMappingURL=BlockRefreshAction.js.map

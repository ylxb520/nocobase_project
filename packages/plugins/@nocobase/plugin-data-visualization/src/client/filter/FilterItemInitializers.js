...
const FieldComponentProps = observer(
  (props) => {
    const form = useForm();
    const schema = getPropsSchemaByComponent(form.values.component);
    return schema ? React.createElement(SchemaComponent, { schema: schema, ...props }) : null;
  },
...
const ErrorFallback = ({ error }) => {
  return React.createElement(
    ...
    React.createElement(
      Text,
      { type: 'danger', style: { whiteSpace: 'pre-line', textAlign: 'center', padding: '5px' } },
      error.message,
    ),
  );
};
  ...
  (props) => {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          CollectionFieldProvider,
          { name: schema.name, allowNull: !schema['x-collection-field'] },
          React.createElement(
            ACLCollectionFieldProvider,
            null,
            React.createElement(
              ErrorBoundary,
              { onError: console.log, FallbackComponent: ErrorFallback },
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(FormItem, { className: className, ...props, extra: extra }),
                ),
              ),
            ),
          ),
...
export const ChartFilterCustomItemInitializer = memo((props) => {
  ...
  const handleClick = useCallback(async () => {
    const values = await FormDialog(
      ...
      () =>
        React.createElement(
          SchemaComponentOptions,
          { scope: { ...scope, useChartFilterSourceFields }, components: { ...components, FieldComponentProps } },
          React.createElement(
            FormLayout,
            { layout: 'vertical' },
      ...
      effects() {
        onFieldValueChange('source', (field) => {
          ...
          if (fieldComponentValues.includes(uiSchema['x-component'])) {
            ...
            const componentProps = field.query('.props').take();
          ...
          const component = field.query('.component').take();
  ...
  return React.createElement(SchemaInitializerItem, { ...itemConfig, ...props, onClick: handleClick });
});
  ...
  items: [
    ...
    },
    {
      ...
      Component: () => {
        ...
        return React.createElement(ChartFilterCustomItemInitializer, { insert: (s) => insertAdjacent('beforeEnd', s) });
      },
    },
  ],
};
...
//# sourceMappingURL=FilterItemInitializers.js.map

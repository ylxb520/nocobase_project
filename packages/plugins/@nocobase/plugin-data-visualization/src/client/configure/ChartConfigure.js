...
import { createForm, onFieldChange, onFormInit } from '@formily/core';
import { FormConsumer, Schema } from '@formily/react';
import {
  AutoComplete,
  FormProvider,
  SchemaComponent,
...
export const ChartConfigure = (props) => {
  ...
  const RunButton = memo(() =>
    React.createElement(
      Button,
      {
        ...
        icon: React.createElement(RightSquareOutlined, null),
        onClick: async () => {
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(Tabs, {
                tabBarExtraContent: React.createElement(RunButton, null),
                items: [
                  {
                    label: t('Query'),
                    key: 'query',
                    children: React.createElement(ChartConfigure.Query, null),
                  },
                  {
                    label: t('Data'),
                    key: 'data',
                    children: React.createElement(ChartConfigure.Data, null),
                  },
                ],
              }),
            ),
                ...
                items: [
                  {
                    label: t('Chart'),
                    key: 'chart',
                    children: React.createElement(ChartConfigure.Config, null),
                  },
                  {
                    label: t('Transformation'),
                    key: 'transformation',
                    children: React.createElement(ChartConfigure.Transform, null),
                  },
                ],
              }),
            ),
          ),
          React.createElement(Col, { span: 11 }, React.createElement(ChartConfigure.Renderer, null)),
        ),
      ),
    ),
  );
...
ChartConfigure.Renderer = function Renderer(props) {
  ...
  const { service } = useContext(ChartRendererContext);
  return React.createElement(FormConsumer, null, (form) => {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        { value: { collection, config, transform, service, data } },
        React.createElement(ChartRenderer, { ...props }),
      ),
    );
  });
};
ChartConfigure.Query = function Query() {
  ...
  const FromSql = () =>
    React.createElement(
      ...
      { code: true },
      'From ',
      React.createElement('span', { style: { color: '#1890ff' } }, current?.collection),
    );
...
ChartConfigure.Config = function Config() {
  ...
  const getReference = (chartType) => {
    ...
    return React.createElement(
      ...
      null,
      t('Config reference: '),
      React.createElement('a', { href: link, target: '_blank', rel: 'noreferrer' }, t(title)),
    );
  };
...
ChartConfigure.Data = function Data() {
  ...
  return !error
    ...
    : React.createElement(Alert, {
        message: 'Error',
        type: 'error',
        description: error?.response?.data?.errors?.map?.((error) => error.message).join('\n') || error.message,
        showIcon: true,
      });
};
//# sourceMappingURL=ChartConfigure.js.map

 ...
 */
export const ChartV2BlockDesigner = () => {
  ...
  return React.createElement(
    GeneralSchemaDesigner,
    { title: t('Charts'), showDataSource: false },
    React.createElement(SchemaSettingsBlockTitleItem, null),
    React.createElement(SchemaSettingsSwitchItem, {
...
//# sourceMappingURL=ChartBlockDesigner.js.map

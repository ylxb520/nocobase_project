...
export const TemplateGridDecorator = observer((props) => {
  ...
  return React.createElement(SchemaComponentOnChangeContext.Provider, { value: { onChange } }, props.children);
});
//# sourceMappingURL=TemplateGridDecorator.js.map

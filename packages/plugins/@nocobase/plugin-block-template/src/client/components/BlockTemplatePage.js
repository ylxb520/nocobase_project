  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Breadcrumb, {
        items: [
          {
            title: React.createElement(Link, { to: `/admin/settings/ui-templates/inherited-v1` }, t('Block template')),
          },
          {
            title: title,
          },
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        { value: data?.data },
        React.createElement(RemoteSchemaComponent, { uid: schemaUid }),
      ),
    ),
  );
};
//# sourceMappingURL=BlockTemplatePage.js.map

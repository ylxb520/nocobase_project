...
const BlockTemplateMenusContext = createContext({
  loading: false,
  templates: [],
...
export const BlockTemplateMenusProvider = ({ children }) => {
  ...
  const handleTemplateClick = useMemoizedFn(async ({ item }, options, insert) => {
    const { uid } = item;
...
//# sourceMappingURL=BlockTemplateMenusProvider.js.map

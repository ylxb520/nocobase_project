 ...
 */
import { SchemaSettingsModalItem, useResource, useSchemaSettings, useSchemaTemplateManager } from '@nocobase/client';
...
function getTemplateSchemaFromPage(schema) {
  const templateSchema = {};
  const traverseSchema = (s, t) => {
...
async function containsReferenceTemplate(schema, schemaTemplateManager) {
...
//# sourceMappingURL=SaveAsTemplateSetting.js.map

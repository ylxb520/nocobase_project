...
export const hideConvertToBlockSettingItem = (settingItem, preSettingItem, nextSettingItem) => {
  if (
...
export const hideDeleteSettingItem = (settingItem, preSettingItem) => {
  if (
...
export const hideBlocksFromTemplate = (initializers, app) => {
...
export const hideConnectDataBlocksFromTemplate = (settingItem) => {

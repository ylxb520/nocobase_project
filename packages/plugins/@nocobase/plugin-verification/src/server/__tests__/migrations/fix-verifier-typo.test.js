...
describe('providers to verificators', () => {
    ...
    it('should migrate providers to verificators', async () => {
        ...
        expect(verifiers[0]).toMatchObject(expect.objectContaining({
            name: 'test',
            title: 'SMS OTP',
            verificationType: 'sms-otp',
        }));
        ...
        expect(through[0]).toMatchObject(expect.objectContaining({
            verifier: 'test',
            userId: 1,
            uuid: '13888888888',
        }));
...
//# sourceMappingURL=fix-verifier-typo.test.js.map
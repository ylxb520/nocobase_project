...
test.describe('filter', () => {
    test('Collection event add data trigger, normal table integer fields not de-emphasised COUNT', async ({ page, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        ...
        await mockCollections(appendJsonCollectionName(JSON.parse(JSON.stringify(generalWithNoRelationalFields)), aggregateNodeAppendText)
            .collections);
    ...
    test('Collection event add data trigger, normal table integer fields not de-emphasised SUM', async ({ page, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        const triggerNodeAppendText = 'a' + faker.string.alphanumeric(4);
        const aggregateNodeAppendText = 'b' + faker.string.alphanumeric(4);
        //创建触发器节点数据表
    ...
    test('Collection event add data trigger, normal table integer fields not de-emphasised AVG', async ({ page, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        const triggerNodeAppendText = 'a' + faker.string.alphanumeric(4);
        const aggregateNodeAppendText = 'b' + faker.string.alphanumeric(4);
        //创建触发器节点数据表
    ...
    test('Collection event add data trigger, normal table integer fields not de-emphasised MIN', async ({ page, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        const triggerNodeAppendText = 'a' + faker.string.alphanumeric(4);
        const aggregateNodeAppendText = 'b' + faker.string.alphanumeric(4);
        //创建触发器节点数据表
    ...
    test('Collection event add data trigger, normal table integer fields not de-emphasised MAX', async ({ page, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        const triggerNodeAppendText = 'a' + faker.string.alphanumeric(4);
        const aggregateNodeAppendText = 'b' + faker.string.alphanumeric(4);
        //创建触发器节点数据表
    ...
    test('Collection event add data trigger, normal table integer fields de-weighting COUNT', async ({ page, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        const triggerNodeAppendText = 'a' + faker.string.alphanumeric(4);
        const aggregateNodeAppendText = 'b' + faker.string.alphanumeric(4);
        //创建触发器节点数据表
    ...
    test.skip('Collection event add data trigger, normal table integer fields de-weighting SUM', async ({ page, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        const triggerNodeAppendText = 'a' + faker.string.alphanumeric(4);
        const aggregateNodeAppendText = 'b' + faker.string.alphanumeric(4);
        //创建触发器节点数据表
    ...
    test.skip('Collection event add data trigger, normal table integer fields de-weighting AVG', async ({ page, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        const triggerNodeAppendText = 'a' + faker.string.alphanumeric(4);
        const aggregateNodeAppendText = 'b' + faker.string.alphanumeric(4);
        //创建触发器节点数据表
        ...
        const aggregateNodeCollectionDataDistinctCount = aggregateNodeCollectionDataDistinct.reduce((count, currentValue) => {
            return currentValue > 3 ? count + 1 : count;
        }, 0);
        // aggregateNodeCollectionDataDistinct中staffnum字段值大于3的平均值
        const aggregateNodeCollectionDataDistinctAvg = aggregateNodeCollectionDataDistinct.reduce((total, currentValue) => {
            return currentValue > 3 ? total + currentValue : total;
    ...
    test.skip('Collection event add data trigger, normal table integer fields de-weighting MIN', async ({ page, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        const triggerNodeAppendText = 'a' + faker.string.alphanumeric(4);
        const aggregateNodeAppendText = 'b' + faker.string.alphanumeric(4);
        //创建触发器节点数据表
    ...
    test.skip('Collection event add data trigger, normal table integer fields de-weighting MAX', async ({ page, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        const triggerNodeAppendText = 'a' + faker.string.alphanumeric(4);
        const aggregateNodeAppendText = 'b' + faker.string.alphanumeric(4);
        //创建触发器节点数据表
...
//# sourceMappingURL=DataOfCollection.test.js.map
...
const AppVisitor = () => {
    ...
    const link = useLink();
    return (React.createElement("a", { href: link, target: '_blank', rel: "noreferrer" }, t('View', { ns: 'client' })));
};
export const AppManager = () => {
    return (React.createElement(Card, { bordered: false },
        React.createElement(SchemaComponent, { schema: getSchema(), components: { AppVisitor, JwtSecretInput } })));
};

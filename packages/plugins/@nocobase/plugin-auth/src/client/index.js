...
const useSignIn = function (name) {
  const useSignIn = useLazy(() => import('./basic'), 'useSignIn');
  return useSignIn(name);
};
const useRedirect = function (next = '/admin') {
  const useRedirect = useLazy(() => import('./basic'), 'useRedirect');

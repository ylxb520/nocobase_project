...
export const ResetPasswordPage = () => {
  ...
  if (!resetToken || expired) {
    return React.createElement(Result, {
      ...
      extra: React.createElement(Button, { type: 'primary', onClick: () => navigate('/signin') }, t('Go to login')),
    });
  }
  return React.createElement(SchemaComponent, { schema: getResetPasswordForm(), scope: { t } });
};

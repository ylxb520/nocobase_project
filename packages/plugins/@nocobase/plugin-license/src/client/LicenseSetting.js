...
function InstanceId() {
    ...
    return (React.createElement(Button, { onClick: async () => {
        ...
        }, loading: loading, icon: React.createElement(CopyOutlined, null), type: "link" }, t('Copy')));
}
const TextArea = ({ ...props }) => {
    ...
    if (isEdit) {
        return React.createElement(Input.TextArea, { rows: 4, ...props });
    }
    if (keyExist) {
...
const LicenseCardWarp = () => {
    ...
    return (React.createElement(SchemaComponent, { key: refreshToken, schema: {
            type: 'void',
            properties: {
                card: {
                    type: 'void',
...
export default function LicenseSetting() {
    ...
    return (React.createElement(Card, { bordered: false },
        React.createElement(LicenseSettingContext.Provider, { value: {
                onSaveSuccess: () => {
                    setRenderKey((k) => k + 1);
                    setKeyExist(true);
                },
            ...
            React.createElement(ServiceValidate, { refreshToken: renderKey }),
            React.createElement(SchemaComponent, { scope: { useSubmitProps }, components: { InstanceId, TextArea, LicenseCardWarp }, schema: {
                    type: 'void',
                    properties: {
...
//# sourceMappingURL=LicenseSetting.js.map
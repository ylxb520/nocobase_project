import { AntdSchemaComponentProvider, APIClient, APIClientProvider, Application, BlockSchemaComponentProvider, SchemaComponent, SchemaComponentProvider, ExtendCollectionsProvider, } from '@nocobase/client';
...
mock(apiClient);
const Root = () => {
    return (React.createElement(APIClientProvider, { apiClient: apiClient },
        React.createElement(SchemaComponentProvider, null,
            React.createElement(ExtendCollectionsProvider, { collections: collections.data },
                React.createElement(AntdSchemaComponentProvider, null,
                    React.createElement(BlockSchemaComponentProvider, null,

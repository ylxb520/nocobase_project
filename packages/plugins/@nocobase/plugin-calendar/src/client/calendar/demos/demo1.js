 ...
 * title: Calendar
 */
import { Application, Plugin, AntdSchemaComponentProvider, SchemaComponent, SchemaComponentProvider, } from '@nocobase/client';
...
const Root = () => {
    return (React.createElement(SchemaComponentProvider, null,

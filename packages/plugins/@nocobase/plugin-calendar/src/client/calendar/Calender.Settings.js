...
import { SchemaSettings, SchemaSettingsBlockHeightItem, SchemaSettingsBlockTitleItem, SchemaSettingsCascaderItem, SchemaSettingsDataScope, SchemaSettingsSelectItem, SchemaSettingsSwitchItem, SchemaSettingsTemplate, removeNullCondition, useBlockTemplateContext, useCollection, useCollectionManager_deprecated, useDesignable, useFormBlockContext, usePopupSettings, useApp, SchemaSettingsLinkageRules, LinkageRuleCategory, useCollection_deprecated, } from '@nocobase/client';
...
export const ShowLunarDesignerItem = () => {
    ...
    return (React.createElement(SchemaSettingsSwitchItem, { title: t('Show lunar'), checked: field.decoratorProps.showLunar, onChange: (v) => {
    ...
    items: [
        ...
        },
        {
            ...
            useComponentProps() {
                ...
                const defaultResource = fieldSchema?.['x-decorator-props']?.resource || fieldSchema?.['x-decorator-props']?.association;
                return {
...
//# sourceMappingURL=Calender.Settings.js.map
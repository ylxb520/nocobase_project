...
import { useSchemaTemplateManager, useCollectionManager_deprecated, useGlobalTheme, FormDialog, SchemaComponentOptions, SchemaComponent, useRecordCollectionDataSourceItems, useSchemaInitializerItem, useSchemaInitializer, SchemaInitializerItem, } from '@nocobase/client';
...
export const RecordAssociationCalendarBlockInitializer = () => {
    ...
    return (React.createElement(SchemaInitializerItem, { icon: React.createElement(TableOutlined, null), ...others, onClick: async ({ item }) => {
            if (item.template) {
...
//# sourceMappingURL=RecordAssociationCalendarBlockInitializer.js.map
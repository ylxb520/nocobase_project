...
const InternalCalendarBlockProvider = (props) => {
    ...
    return (React.createElement(CalendarBlockContext.Provider, { value: {
            field,
            service,
            resource,
...
export const CalendarBlockProvider = withDynamicSchemaProps((props) => {
    ...
    return (React.createElement("div", { key: props.fieldNames.colorFieldName },
        React.createElement(BlockProvider, { name: "calendar", ...props, params: params },
            React.createElement(InternalCalendarBlockProvider, { ...props }))));
...
//# sourceMappingURL=CalendarBlockProvider.js.map
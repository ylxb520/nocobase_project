...
import { CalendarActionInitializers_deprecated, CalendarFormActionInitializers, calendarActionInitializers, deleteEventActionInitializer, } from './schema-initializer/initializers';
import { CalendarBlockInitializer, RecordAssociationCalendarBlockInitializer, useCreateAssociationCalendarBlock, useCreateCalendarBlock, } from './schema-initializer/items';
const TitleRenderer = ({ value }) => {
    return React.createElement("span", { "aria-label": "event-title" }, value || 'N/A');
};
...
export class PluginCalendarClient extends Plugin {
    ...
    registerDateTimeFieldInterface(data) {

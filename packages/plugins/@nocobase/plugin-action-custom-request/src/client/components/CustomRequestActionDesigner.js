...
export function CustomRequestSettingsItem() {
  ...
  return React.createElement(
    React.Fragment,
    null,
    React.createElement(SchemaSettingsActionModalItem, {
 ...
 * @deprecated
 */
export const CustomRequestActionDesigner = () => {
  const customRequestsResource = useCustomRequestsResource();
  const fieldSchema = useFieldSchema();
  return React.createElement(Action.Designer, {
    linkageAction: true,
...
//# sourceMappingURL=CustomRequestActionDesigner.js.map

...
describe('server hooks', () => {
    ...
    beforeEach(async () => {
        ...
        uiSchemaPlugin = app.getPlugin('ui-schema-storage');
    });
    ...
    it('should bind menu to role when insert new menu using insertAdjacent', async () => {
        ...
        const role1Menus = await db.getRepository('roles.menuUiSchemas', 'role1').find();
    ...
    it('should bind menu to role when create new menu', async () => {
        ...
        const role1Menus = await db.getRepository('roles.menuUiSchemas', 'role1').find();
        expect(role1Menus.length).toEqual(1);
        const role2Menus = await db.getRepository('roles.menuUiSchemas', 'role2').find();
    ...
    it('should remove parents on self move', async () => {
        ...
        await uiSchemaRepository.insert(schema);
        await uiSchemaRepository.insertAdjacent('afterEnd', 'E', {
            'x-uid': 'D',
        }, {
            wrap: {
                'x-uid': 'F',
...
//# sourceMappingURL=server-hook-impl.test.js.map
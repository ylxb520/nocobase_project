...
export const QRCodeScanner = (props) => {
    ...
    return visible && cameraAvaliable ? (React.createElement("div", { style: style },
        React.createElement(QRCodeScannerInner, { setVisible: setVisible }),

...
const ResponsiveSpace = () => {
  ...
  if (underMobileCtx || isMobileMedia) {
    return React.createElement(
      Grid,
      { columns: itemsPerRow, gap: gap },
      fieldSchema.mapProperties((s, key) => {
        return React.createElement(NocoBaseRecursionField, { name: key, schema: s, key: key });
      }),
    );
  }
  return React.createElement(
    Space,
    { wrap: true, size: gap, align: 'start' },
    fieldSchema.mapProperties((s, key) => {
      return React.createElement(NocoBaseRecursionField, { name: key, schema: s, key: key });
    }),
  );
...
const InternalIcons = () => {
  ...
  return React.createElement(
    'div',
    { className: 'nb-action-panel-warp' },
    React.createElement(
      DndContext,
      null,
      layout === WorkbenchLayout.Grid
        ? React.createElement(ResponsiveSpace, null)
        : React.createElement(
            List,
            {
              style: {
            ...
            fieldSchema.mapProperties((s, key) => {
              return React.createElement(NocoBaseRecursionField, { name: key, schema: s });
            }),
          ),
    ),
  );
...
const useStyles = createStyles(({ token, css }) => ({
  containerClass: css`
    &.list {
      ...
      border-radius: ${token.borderRadiusBlock}px;
      overflow: hidden;
...
export const WorkbenchBlock = withDynamicSchemaProps(
  (props) => {
    const fieldSchema = useFieldSchema();
    ...
    return React.createElement(
      'div',
      { className: `nb-action-penal-container ${layout} ${styles.containerClass} ${heightClass}` },
      React.createElement(
        WorkbenchBlockContext.Provider,
        { value: { layout, ellipsis } },
        React.createElement(
          DataSourceContext.Provider,
          { value: undefined },
          React.createElement(CollectionContext.Provider, { value: undefined }, props.children),
        ),
      ),
    );
  },
...
WorkbenchBlock.ActionBar = () => {
  return React.createElement(
    React.Fragment,
    null,
    React.createElement(InternalIcons, null),
    React.createElement(ConfigureActionsButton, null),
  );
};
//# sourceMappingURL=WorkbenchBlock.js.map

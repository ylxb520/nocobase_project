...
import { WorkbenchPopupActionSchemaInitializerItem, workbenchActionSettingsPopup, } from './WorkbenchPopupActionSchemaInitializerItem';
import { WorkbenchScanActionSchemaInitializerItem, workbenchActionSettingsScanQrCode, } from './WorkbenchScanActionSchemaInitializerItem';
import { WorkbenchCustomRequestActionSchemaInitializerItem, workbenchActionSettingsCustomRequest, } from './WorkbenchCustomRequestActionSchemaInitializerItem';
...
export class PluginBlockWorkbenchClient extends Plugin {
    async load() {
        ...
        // 添加到页面的 Add block 里
        this.app.schemaInitializerManager.addItem('page:addBlock', `otherBlocks.${workbenchBlockInitializerItem.name}`, workbenchBlockInitializerItem);
        // 添加到弹窗的 Add block 里
        this.app.schemaInitializerManager.addItem('popup:common:addBlock', `otherBlocks.${workbenchBlockInitializerItem.name}`, workbenchBlockInitializerItem);
        // 添加到移动端的 Add block 里
        this.app.schemaInitializerManager.addItem('mobilePage:addBlock', `otherBlocks.${workbenchBlockInitializerItem.name}`, workbenchBlockInitializerItem);
        this.app.schemaInitializerManager.addItem('mobile:addBlock', `otherBlocks.${workbenchBlockInitializerItem.name}`, workbenchBlockInitializerItem);
        // link 操作

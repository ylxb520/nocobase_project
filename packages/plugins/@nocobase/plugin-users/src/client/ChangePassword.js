...
import { ActionContextProvider, DropdownVisibleContext, SchemaComponent, useActionContext, useSystemSettings, zIndexContext, useZIndexContext, SchemaComponentContext, useAPIClient, SchemaSettingsItem, } from '@nocobase/client';
...
export const ChangePassword = () => {
    ...
    const schemaComponent = useMemo(() => {
        return (React.createElement(SchemaComponentContext.Provider, { value: { designable: false } },
            React.createElement(SchemaComponent, { scope: { useCloseAction, useSaveCurrentUserValues }, schema: schema })));
    }, [zIndex]);
    if (enableChangePassword === false) {
        return null;
    }
    return (React.createElement(zIndexContext.Provider, { value: zIndex },
        React.createElement(SchemaSettingsItem, { eventKey: "changePassword", title: "changePassword" },
            React.createElement("div", { onClick: handleClick }, t('Change password'))),

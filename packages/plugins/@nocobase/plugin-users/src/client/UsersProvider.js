 ...
 */
import { ActionContextProvider, DropdownVisibleContext, ExtendCollectionsProvider, RemoteSchemaComponent, SchemaComponent, useAPIClient, useActionContext, useCollectValuesToSubmit, useCollectionManager, useCurrentUserContext, useCurrentUserSettingsMenu, useSystemSettings, } from '@nocobase/client';
            ...
            label: (React.createElement("div", null,
                ...
                React.createElement(ActionContextProvider, { value: { visible, setVisible } },
                    React.createElement("div", { onClick: (e) => e.stopPropagation() },
                        React.createElement(SchemaComponent, { components: { ProfileEditForm }, schema: {
                                type: 'object',
                                properties: {
                                    [uid()]: {

...
export class UserDataSyncService {
    ...
    async runSync(source, task, ctx) {
        ...
        try {
            ...
            ctx.log.error(`sync task of source: ${source.instance.name} sourceType: ${source.instance.sourceType} error: ${err.message}`, { method: 'runSync', err: err.stack, cause: err.cause });
...
//# sourceMappingURL=user-data-sync-service.js.map
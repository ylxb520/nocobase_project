...
const TextCopyButton = observer(() => {
    ...
    return (React.createElement(Typography.Text, { ref: buttonRef, copyable: {
            text: field.value,
...
class PluginTextCopy extends Plugin {
    async load() {
        const copyButton = React.createElement(TextCopyButton, null);
        this.app.addScopes({

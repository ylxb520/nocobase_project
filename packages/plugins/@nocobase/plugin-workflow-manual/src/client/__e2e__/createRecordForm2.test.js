...
test.describe('action button', () => {
    test('Collection event to add a data trigger, entering a single line of text data, continue the process', async ({ page, mockPage, mockCollections, mockRecords, }) => {
        //数据表后缀标识
    ...
    test('Collection event to add a data trigger, entering a single line of text data, terminate the process', async ({ page, mockPage, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        const triggerNodeAppendText = 'a' + faker.string.alphanumeric(4);
        const manualNodeAppendText = 'b' + dayjs().format('HHmmss').toString();
        // 创建触发器节点数据表
    ...
    test('Collection event to add a data trigger, entering a single line of text data, save temporarily', async ({ page, mockPage, mockCollections, mockRecords, }) => {
        //数据表后缀标识
        const triggerNodeAppendText = 'a' + faker.string.alphanumeric(4);
        const manualNodeAppendText = 'b' + dayjs().format('HHmmss').toString();
        // 创建触发器节点数据表
...
//# sourceMappingURL=createRecordForm2.test.js.map
...
test.describe('field data entry', () => {
    test('Collection event to add a data trigger, entering percentage data', async ({ page, mockPage, mockCollections, mockRecords, }) => {
        ...
        const hasInsuranceratio = Object.values(manualNodeJobResult).some((value) => value.insuranceratio === manualNodeRecord / 100);
...
//# sourceMappingURL=createRecordForm1.test.js.map
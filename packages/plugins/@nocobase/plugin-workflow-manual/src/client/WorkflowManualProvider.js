 ...
 * @returns
 */
export const WorkflowManualProvider = (props) => {
    return React.createElement(ExtendCollectionsProvider, { collections: [todoCollection] }, props.children);
};
/**
 * 2. 将区块相关的按钮 Schema 缓存起来，这样就可以在弹窗中获取到 Schema，进而实现“弹窗 URL”的功能；
 */
function cacheSchema(collectionNameList) {
...
//# sourceMappingURL=WorkflowManualProvider.js.map
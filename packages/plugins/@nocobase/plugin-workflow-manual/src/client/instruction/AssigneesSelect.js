...
export function AssigneesSelect({ multiple = false, value = [], onChange }) {
    ...
    return (React.createElement(Variable.Input, { scope: scope, value: value[0], onChange: (next) => {
            onChange([next]);
        } },
        React.createElement(RemoteSelect, { fieldNames: {
                ...
                resource: 'users',
            }, manual: false, value: value[0], onChange: (v) => {
                onChange(v != null ? [v] : []);
            } })));
}
//# sourceMappingURL=AssigneesSelect.js.map
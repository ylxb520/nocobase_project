...
import { joinCollectionName, useApp, useCompile, useDataSourceManager, } from '@nocobase/client';
import { defaultFieldNames, getCollectionFieldOptions, CollectionBlockInitializer, Instruction, WorkflowVariableTextArea, useNodeContext, } from '@nocobase/plugin-workflow/client';
...
function useInitializers(node) {
    ...
    const forms = formKeys
        ...
        const { fields = [] } = typeof form.collection === 'string'

...
const filterModelsBySearch = (models, searchTerm) => {
...
describe('LLM Services API Logic', () => {
  ...
  describe('P0: modelOptions data structure', () => {
    ...
    it('should have correct default values for modelOptions', () => {
      ...
      expect(defaultModelOptions.webSearch).toBeUndefined();
      expect(defaultModelOptions.maxTokens).toBeUndefined();
    });
    it('should store modelOptions separately from provider options', () => {
      const llmService = {
        ...
        enabledModels: { mode: 'provider', models: [{ label: 'GPT-4o', value: 'gpt-4o' }] },
        modelOptions: {
          temperature: 0.7,
          topP: 0.9,
      ...
      expect(llmService.options.temperature).toBeUndefined();
...
//# sourceMappingURL=llm-services.test.js.map

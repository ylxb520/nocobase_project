...
const useDefaultOnOk = (decisions) => {
  return {
    onOk: async () => {},
  };
};
export const ToolModal = observer(() => {
  const t = useT();
  ...
  return React.createElement(
    Modal,
    {
      ...
      footer: (_, { OkBtn }) => React.createElement(React.Fragment, null, React.createElement(OkBtn, null)),
    },
    C ? React.createElement(C, { tool: activeTool, saveToolArgs: saveToolArgs }) : null,
  );
});

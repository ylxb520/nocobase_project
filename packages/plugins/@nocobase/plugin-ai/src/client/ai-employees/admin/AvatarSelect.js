...
export const Avatar = ({ srcs, size = 'large', selectable, highlightItem, onClick }) => {
  ...
  const list =
    srcs?.map(([src, name], index) =>
      React.createElement(
        'div',
        { key: index, className: `${prefixCls}-list-picture-card-container ${prefixCls}-list-item-container` },
        React.createElement(
          'div',
          {
          ...
          React.createElement(
            ...
            React.createElement(
              'span',
              { key: 'thumbnail', className: `${prefixCls}-list-item-thumbnail` },
              React.createElement('img', { src: src, className: `${prefixCls}-list-item-image` }),
            ),
          ),
        ),
      ),
  ...
  return React.createElement(List, {
    ...
    renderItem: ([src, name]) => {
      return React.createElement(
        List.Item,
        null,
        React.createElement(AntdAvatar, {
  ...
  return wrapSSR(
    React.createElement(
      ...
      React.createElement('div', { className: cls(`${prefixCls}-list`, `${prefixCls}-list-picture-card`) }, list),
    ),
  );
};
export const AvatarSelect = ({ disabled }) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Avatar, { srcs: current ? [[avatars(current), current]] : [] }),
    ),
    !(disabled === true)
...
//# sourceMappingURL=AvatarSelect.js.map

...
const BuiltInAboutField = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Radio, { value: 'system' }, t('System default')),
      React.createElement(Radio, { value: 'custom' }, t('Custom')),
    ),
    mode === 'system'
      ? React.createElement(
          'div',
      ...
      : React.createElement(Variable.RawTextArea, {
...
const StandardAboutField = () => {
  const t = useT();
  const form = useForm();
  const options = useVariableOptions();
  return React.createElement(Variable.RawTextArea, {
    value: form.values.about ?? '',
    onChange: (e) => {
      form.setValuesIn('about', e.target.value);
    },
...
const AboutField = () => {
  ...
  if (isBuiltIn) {
    return React.createElement(BuiltInAboutField, null);
  }
  return React.createElement(StandardAboutField, null);
};

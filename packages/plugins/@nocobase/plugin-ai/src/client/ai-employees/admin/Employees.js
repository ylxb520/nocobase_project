    ...
    items: [
      {
        key: 'profile',
        label: t('Profile'),
        children: React.createElement(ProfileSettings, { edit: edit }),
        forceRender: true,
      },
      {
        key: 'roleSetting',
        label: t('Role setting'),
        children: React.createElement(SystemPrompt, null),
        forceRender: true,
      },
      // {
      //   key: 'chat',
      ...
      // },
      {
        key: 'skills',
        label: t('Skills'),
        children: React.createElement(SkillSettings, null),
      },
        ...
        ? [
            {
              ...
              children: React.createElement(KnowledgeBaseSettings, null),
            },
          ]
        : []),
    ],
...
const Avatar = (props) => {
  ...
  return React.createElement(AntdAvatar, { shape: 'square', size: 'large', ...props, src: avatars(field.value) });
};
const Enabled = (props) => {
  const field = useField();
  if (!field.value) {
  ...
  return field.value && React.createElement(CheckOutlined, { style: { color: '#52c41a' } });
};
export const Employees = () => {
  const t = useT();
  return React.createElement(
    ExtendCollectionsProvider,
    { collections: [aiEmployees] },

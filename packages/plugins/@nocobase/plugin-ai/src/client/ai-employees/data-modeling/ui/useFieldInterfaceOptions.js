...
const getOptions = (fieldInterfaces, fieldGroups, t) => {
...
export const useFieldInterfaceOptions = () => {
  ...
  return useMemo(() => {
    ...
    const fieldInterfaceInstancesByGroups = fieldInterfaceInstances.reduce((memo, fieldInterface) => {
...
//# sourceMappingURL=useFieldInterfaceOptions.js.map

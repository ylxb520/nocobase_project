...
export const ClassicPagesContext = {
  menu: {
    ...
    'block-ui-schemas': {
      menu: {
        ...
        Component: ({ onAdd }) => {
          const t = useT();
          const { t: collectionT } = useTranslation('lm-collections');
          return React.createElement('div', { onClick: () => {} }, t('Select block UI schemas'));
        },
      },
      tag: {
        Component: ({ item }) => {
          return React.createElement(React.Fragment, null, React.createElement(BuildOutlined, null), ' ', item.title);
        },
      },
    },
    'field-values': {
      menu: {
        icon: React.createElement(SelectOutlined, null),
        Component: ({ onAdd }) => {
          const t = useT();
          const addAttachments = useChatMessagesStore.use.addAttachments();
          return React.createElement('div', { onClick: () => {} }, t('Select field values'));
        },
      },
    },
  },
};
//# sourceMappingURL=classic-pages.js.map

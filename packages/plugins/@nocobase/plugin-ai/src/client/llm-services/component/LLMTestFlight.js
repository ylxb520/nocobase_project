...
export const LLMTestFlight = observer(() => {
  const t = useT();
  const form = useForm();
  ...
  return React.createElement(
    Tooltip,
    { title: t('Test connection with the configured API Key') },
    React.createElement(
      Button,
      { icon: React.createElement(RocketOutlined, null), loading: loading, onClick: handleTest },
      t('Test flight'),
    ),
  );
});
//# sourceMappingURL=LLMTestFlight.js.map

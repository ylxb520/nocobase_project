...
import { useActionContext, useBlockRequestContext, useCollection, useCollectionRecordData, useDataBlockResource, } from '@nocobase/client';
...
export const useFlowModelTemplateSearchProps = () => {
    ...
    return {
        ...
        onSearch: (value) => doSearch(value?.trim?.() || ''),
        allowClear: true,
        style: { width: 260 },
    };
};
...
export const useFlowModelTemplateEditActionProps = () => {
...
export const useFlowModelTemplateDeleteActionProps = () => {
...
//# sourceMappingURL=useFlowModelTemplateActions.js.map
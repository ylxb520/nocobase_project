...
export const TargetKey = observer((props) => {
    ...
    return (React.createElement("div", null,
        React.createElement(Select, { showSearch: true, options: options, onDropdownVisibleChange: async (open) => {
                if (targetKeys && open) {
                    setOptions(targetKeys.map((k) => {
                        return {
                            value: k.name,
...
//# sourceMappingURL=TargetKey.js.map
...
function AssignFieldsEditor() {
  ...
  return formModel ? React.createElement(FlowModelRenderer, { model: formModel, showFlowSettings: false }) : null;
}
    ...
    assignFieldValues: {
      ...
      uiSchema() {
        return {
          editor: {
            'x-decorator': 'FormItem',
            'x-component': () => React.createElement(AssignFieldsEditor, null),
          },
        };
      },
      async beforeParamsSave(ctx) {
        ...
        const form = m?.assignFormUid && ctx.engine.getModel?.(m.assignFormUid, true);
        if (!form) return;
...
//# sourceMappingURL=BulkUpdateActionModel.js.map

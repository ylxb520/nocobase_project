...
const CommentBlockDecoratorContext = createContext({});
export function CommentBlockDecoratorContextProvider(props) {
  ...
  return React.createElement(
    ...
    { value: { createAble, setCreateAble } },
    props.children,
  );
}
...
//# sourceMappingURL=useCommentBlockDecoratorContext.js.map

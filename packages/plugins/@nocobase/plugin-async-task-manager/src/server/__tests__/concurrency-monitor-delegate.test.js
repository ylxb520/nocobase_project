...
describe('concurrency monitor delegate', () => {
  ...
  describe('in `process` mode', () => {
    it('Should all ConcurrencyMonitorHolder instance`s idle be false while CONCURRENCY is zero', () => {
      const CONCURRENCY_MODE = 'process';
      const CONCURRENCY = 0;
  ...
  describe('in `app` mode', () => {
    ...
    it('Should different holder instance have own running tasks count', () => {
      ...
      const PROCESS_CONCURRENCY_MONITOR_1 = new BaseConcurrencyMonitor(CONCURRENCY_1);
      ...
      const PROCESS_CONCURRENCY_MONITOR_2 = new BaseConcurrencyMonitor(CONCURRENCY_2);
...
//# sourceMappingURL=concurrency-monitor-delegate.test.js.map

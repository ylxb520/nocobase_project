...
import { SchemaComponent, css, useCompile } from '@nocobase/client';
import { Instruction, RadioWithTooltip, WorkflowVariableInput, defaultFieldNames, BaseTypeSets, ValueBlock, } from '@nocobase/plugin-workflow/client';
...
const Calculation = {
    Step({ children }) {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(Flex, { align: "center" },
                React.createElement(ArrowDownOutlined, { className: css `
              margin: 1em;
            ` }),
                React.createElement(Tag, { color: color, className: css `
              font-size: 10px;
              line-height: 14px;
            ` }, compile(label)))));
    },
    ...
    Addition() {
        ...
        return items.length ? (React.createElement(Dropdown, { disabled: disabled, menu: {
                items,
                onClick({ key }) {
            ...
            React.createElement(Button, { icon: React.createElement(PlusOutlined, null) }, langAddStep))) : (React.createElement(Button, { disabled: true }, langResult));
    },
    Removable({ children }) {
...
export default class extends Instruction {
    ...
    icon = (React.createElement(CalendarOutlined, null));
    fieldset = {
        input: {
            type: 'string',
        ...
        inputType: {
            ...
            'x-component-props': {
                options: [
                    {
                        label: (React.createElement(Tag, { color: DATA_TYPES_OPTION_MAP['date'].color },
                            React.createElement(Trans, { ns: NAMESPACE }, 'Date type'))),
                        value: 'date',
                    ...
                    {
                        label: (React.createElement(Tag, { color: DATA_TYPES_OPTION_MAP['number'].color },
                            React.createElement(Trans, { ns: NAMESPACE }, 'Number type'))),
                        value: 'number',

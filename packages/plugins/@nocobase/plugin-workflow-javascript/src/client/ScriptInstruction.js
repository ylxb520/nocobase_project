...
import { BaseTypeSets, Instruction, ValueBlock, WorkflowVariableInput, defaultFieldNames, } from '@nocobase/plugin-workflow/client';
...
function useScriptDescription() {
    return (React.createElement("div", null,
        React.createElement("span", null, lang('Node.js features supported can be found in the documentaion: ')),
        React.createElement("a", { href: lang('https://docs.nocobase.com/handbook/workflow-javascript'), target: "_blank", rel: "noreferrer" }, lang('JavaScript node'))));
}
...
//# sourceMappingURL=ScriptInstruction.js.map
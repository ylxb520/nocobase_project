 ...
 */
import { createTextSettingsItem, SchemaSettings, SchemaToolbar, SchemaToolbarProvider, useSchemaToolbar, } from '@nocobase/client';
...
export const MobilePageTabsSettings = ({ tab }) => {
    return (React.createElement(SchemaToolbarProvider, { tab: tab },
        React.createElement(SchemaToolbar, { settings: mobilePageTabsSettings, showBackground: true, showBorder: false, toolbarStyle: { inset: '0 -12px' }, spaceWrapperStyle: { top: 3 } })));
};

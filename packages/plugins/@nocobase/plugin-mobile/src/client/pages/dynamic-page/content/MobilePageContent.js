...
export const MobilePageContent = () => {
    ...
    return (React.createElement(MobilePageContentContainer, null,
        React.createElement(RemoteSchemaComponent, { uid: tabSchemaUid || activeTabBarItem?.children?.[0]?.schemaUid, NotFoundPage: 'MobileNotFoundPage', memoized: false })));
};
//# sourceMappingURL=MobilePageContent.js.map
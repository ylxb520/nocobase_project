...
import { SchemaInitializer, useSchemaInitializer, useSchemaInitializerRender, SchemaInitializerActionModal, } from '@nocobase/client';
...
export const mobilePagesTabInitializer = new SchemaInitializer({
    ...
    Component: () => {
        ...
        return (React.createElement(SchemaInitializerActionModal, { title: generatePluginTranslationTemplate('Add tab'), btnStyles: { width: 32, padding: 0, marginRight: 12 }, onSubmit: async ({ title, icon }) => {

 ...
 */
import { SchemaSettings, SchemaSettingsActionLinkItem, useSchemaInitializer, } from '@nocobase/client';
...
export const getMobileNavigationBarLinkSchema = (values) => ({
    type: 'void',
    'x-component': 'Action',
...
export const mobileNavigationBarLinkInitializerItem = {
    name: 'link',
    type: 'actionModal',
    useComponentProps() {

...
export function UserCenter() {
    ...
    return React.createElement("div", { style: { display: 'inline-block', width: '100%' } }, render({ mode: 'inline' }));
}
export const InternalSettings = () => {
    ...
    return (React.createElement(SortableItem, { className: cx('nb-mobile-setting'), style: style },
        React.createElement(Designer, null),
        React.createElement(UserCenter, null)));
};
export const MobileSettings = InternalSettings;
//# sourceMappingURL=MobileSettings.js.map
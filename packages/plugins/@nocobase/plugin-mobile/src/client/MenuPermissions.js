...
export const MenuPermissions = ({ active }) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Table, { className: style, loading: loading, rowKey: 'id', pagination: false, expandable: {
                ...
                },
                {
                    ...
                    title: (React.createElement(React.Fragment, null,
                        React.createElement(Checkbox, { checked: allChecked, onChange: async (value) => {
                                if (allChecked) {
                                    await resource.set({
                                        values: [],
                                    });
...
export const MobileAllRoutesProvider = ({ children, active }) => {
    ...
    return (React.createElement(MobileRoutesProvider, { action: "list", refreshRef: refreshRef, manual: true }, children));
};

...
import { MobilePageNavigationBar, MobilePageProvider, MobilePageTabs, MobileRoutesProvider, MobileTitleProvider, } from '@nocobase/plugin-mobile/client';
    ...
    return (React.createElement("div", { style: { position: 'relative' } },
        React.createElement(MobileTitleProvider, { title: "Title" },
            React.createElement(MobileRoutesProvider, null,
                React.createElement(MobilePageProvider, { displayTabs: true },
                    React.createElement(MobilePageTabs, null),
                    React.createElement("div", null, pathname))))));
};
...
//# sourceMappingURL=pages-page-tabs.js.map
...
const Demo = () => {
    return (React.createElement(SchemaComponent, { schema: schemaViewer(getMobileTabBarItemSchema({
            id: 1,
            type: 'link',
            title: 'Link',
...
class MyPlugin extends Plugin {
    async load() {
        ...
        this.app.router.add('test', {
            path: '/test',
            element: React.createElement("div", null, "Test Page"),
        });
    }
}
const app = mockApp({
...
//# sourceMappingURL=MobileTabBar.Link-schema.js.map
...
class DemoPlugin extends Plugin {
    async load() {
        this.app.router.add('root', { path: '/m', element: React.createElement(Mobile, null) });
        const mobilePlugin = this.pluginManager.get(PluginMobileClient);
        mobilePlugin.mobileRouter.add('mobile.home', {
            path: '/',
            element: React.createElement("div", null, "Custom Home Page"),
        });
    }
}
const app = mockApp({
...
//# sourceMappingURL=pages-home-custom.js.map
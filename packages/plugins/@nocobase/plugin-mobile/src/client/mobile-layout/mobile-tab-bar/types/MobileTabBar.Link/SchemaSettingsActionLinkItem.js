...
export const SchemaSettingsActionLinkItem = () => {
    ...
    return (React.createElement(SchemaSettingsModalItem, { title: t('Edit link'), components: { ArrayItems }, schema: {
            type: 'object',
            title: t('Edit link'),
            properties: {
                url: {
...
//# sourceMappingURL=SchemaSettingsActionLinkItem.js.map
...
describe('MobilePageNavigationBar', () => {
    ...
    it('displayNavigationBar: false', async () => {
        render(React.createElement(NavFalse, null));
        await waitForApp();
        await waitFor(() => {
    ...
    it('displayPageTitle: false', async () => {
        render(React.createElement(NavTitleFalse, null));
        await waitForApp();
        await waitFor(() => {
            expect(screen.queryByText('Title')).not.toBeInTheDocument();
        });
    ...
    it('displayTabs: true', async () => {
        render(React.createElement(NavTabs, null));
        await waitForApp();
        await waitFor(() => {
...
//# sourceMappingURL=MobilePageNavigationBar.test.js.map
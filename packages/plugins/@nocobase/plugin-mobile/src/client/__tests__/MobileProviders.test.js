...
describe('MobileProviders', () => {
    test('MobileTitleProvider', async () => {
        render(React.createElement(MobileTitleProviderApp, null));
        await waitFor(() => {
    ...
    test('MobileRoutesProvider', async () => {
        render(React.createElement(MobileRoutesProviderApp, null));
        await waitForApp();
        await waitFor(() => {
...
//# sourceMappingURL=MobileProviders.test.js.map
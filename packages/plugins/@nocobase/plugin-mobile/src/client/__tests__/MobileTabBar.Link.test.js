...
describe('MobileTabBar.Item', () => {
    test('Inner Link', async () => {
        render(React.createElement(InnerApp, null));
        await waitForApp();
    ...
    test('Outer Link', async () => {
        render(React.createElement(OuterApp, null));
        await waitForApp();
        expect(screen.getByText('Test')).toBeInTheDocument();
        expect(screen.queryByRole('img')).toBeInTheDocument();
    ...
    test('Schema', async () => {
        render(React.createElement(SchemaApp, null));
        await waitForApp();
...
//# sourceMappingURL=MobileTabBar.Link.test.js.map
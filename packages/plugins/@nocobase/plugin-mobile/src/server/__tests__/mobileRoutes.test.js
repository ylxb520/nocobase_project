...
describe('mobileRoutes', async () => {
    let app, db, mobileRoutesRepo, rolesMobileRoutesRepo;
    let role;
    beforeEach(async () => {
    ...
    it(`should rolesMobileRoutes includes tabs when bulk create menu`, async () => {
        ...
        expect(rolesMobileRoutes.map((x) => x.get('mobileRouteId'))).toStrictEqual(expect.arrayContaining([52, 53, 54, 55]));
    });
    it(`should rolesMobileRoutes includes tabs when create menu and invalid data`, async () => {
        ...
        expect(rolesMobileRoutes.map((x) => x.get('mobileRouteId'))).toStrictEqual(expect.arrayContaining([60, 61, 62, 63]));
    });
...
//# sourceMappingURL=mobileRoutes.test.js.map
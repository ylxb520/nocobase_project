...
import { useActionContext, useAPIClient, useBlockRequestContext, useCollection, useDataBlockResource, usePlugin, } from '@nocobase/client';
    ...
    return {
        ...
        async onClick() {
            ...
            if (values[collection.filterTargetKey]) {
                ...
                const schema = initialSchema(values, uiSchemaCallback({
                    collection,
                    dataSource,
...
//# sourceMappingURL=useSubmitActionProps.js.map
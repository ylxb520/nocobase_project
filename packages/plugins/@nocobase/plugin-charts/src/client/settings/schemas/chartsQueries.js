...
import { useActionContext, useRecord, useRequest, useResourceActionContext, useResourceContext, } from '@nocobase/client';
...
export const chartsQueriesSchema = {
    type: 'object',
    properties: {
        [uid()]: {
            type: 'void',
...
//# sourceMappingURL=chartsQueries.js.map
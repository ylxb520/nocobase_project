...
import { ActionContextProvider, SchemaComponent, useActionContext, useRecord, useResourceActionContext, useResourceContext, } from '@nocobase/client';
...
export const AddNewQuery = () => {
    ...
    return (React.createElement(ActionContextProvider, { value: { visible, setVisible } },
        React.createElement(Dropdown, { menu: menu },
            React.createElement(Button, { icon: React.createElement(PlusOutlined, null), type: 'primary' },
                lang('Add query'),
                " ",
                React.createElement(DownOutlined, null))),
        React.createElement(SchemaComponent, { schema: schema, scope: { useCloseAction, useSubmitAction: useCreateAction } })));
};
export const EditQuery = () => {
    ...
    return (React.createElement(ActionContextProvider, { value: { visible, setVisible } },
        ...
        React.createElement(SchemaComponent, { schema: schema, scope: { useCloseAction, useSubmitAction: useUpdateAction } })));
};
//# sourceMappingURL=AddNewQuery.js.map
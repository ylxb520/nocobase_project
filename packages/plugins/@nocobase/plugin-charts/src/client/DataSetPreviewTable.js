...
export default ({ queryId, fields }) => {
  ...
  if (loading) return React.createElement(React.Fragment, null, React.createElement(Spin, null));
  ...
  return React.createElement(
    ...
    { scope: { dataSet }, components: { TableV2, Input, FormItem } },
    React.createElement(SchemaComponent, { schema: schema }),
  );
};
//# sourceMappingURL=DataSetPreviewTable.js.map

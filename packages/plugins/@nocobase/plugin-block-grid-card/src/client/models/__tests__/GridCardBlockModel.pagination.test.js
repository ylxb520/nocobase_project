...
function createGridCardModel(options) {
  ...
  const refresh = vi.fn();
  const model = Object.create(GridCardBlockModel.prototype);
  Object.defineProperty(model, 'resource', {
    configurable: true,
    value: {
      getMeta: (key) => (key === 'count' ? count : key === 'hasNext' ? hasNext : undefined),
...
//# sourceMappingURL=GridCardBlockModel.pagination.test.js.map

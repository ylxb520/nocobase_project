...
import { useColumnSchema, useIsFieldReadPretty, SchemaSettings, useDesignable, fileSizeSetting, } from '@nocobase/client';
    ...
    items: [
        {
            ...
            useComponentProps() {
                ...
                return {
                    ...
                    checked: fieldSchema['x-component-props']?.quickUpload !== false,
                    onChange(value) {
                        const schema = {
                            ['x-uid']: fieldSchema['x-uid'],
                        };
        ...
        },
        {
            ...
            useComponentProps() {
                ...
                return {
                    title: t('Select file'),
                    checked: fieldSchema['x-component-props']?.selectFile !== false,
                    onChange(value) {
                        const schema = {
                            ['x-uid']: fieldSchema['x-uid'],
                        };

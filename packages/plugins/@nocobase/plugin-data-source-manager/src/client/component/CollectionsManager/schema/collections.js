...
import { i18n, useAPIClient } from '@nocobase/client';
...
export const collectionTableSchema = {
  type: 'object',
  properties: {
    [uid()]: {
      type: 'void',
...
export const collectionCategorySchema = {
  type: 'object',
  properties: {
    form: {
      type: 'void',
...
export const collectionCategoryEditSchema = {
  type: 'object',
  properties: {
    form: {
      type: 'void',

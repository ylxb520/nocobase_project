...
const getSchema = (schema, record, compile) => {
  if (!schema) {
    return;
  }
...
export const AddCollectionField = (props) => {
  const record = useRecord();
  return React.createElement(AddFieldAction, { item: record, ...props });
};
  ...
  return (
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Dropdown,
          { getPopupContainer: getContainer, trigger: trigger, align: align, menu: menu },
          children ||
            React.createElement(
              Button,
...
//# sourceMappingURL=AddFieldAction.js.map

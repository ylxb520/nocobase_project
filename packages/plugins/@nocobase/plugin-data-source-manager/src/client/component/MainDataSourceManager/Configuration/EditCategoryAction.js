...
export const EditCategory = (props) => {
  return React.createElement(EditCategoryAction, { ...props });
};
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        null,
        children ||
          React.createElement('span', { onClick: () => setVisible(true) }, compile('{{ t("Edit category") }}')),
      ),
...
//# sourceMappingURL=EditCategoryAction.js.map

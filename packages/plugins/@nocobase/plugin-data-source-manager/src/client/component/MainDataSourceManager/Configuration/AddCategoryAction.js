...
export const AddCategory = (props) => {
  return React.createElement(AddCategoryAction, { ...props });
};
export const AddCategoryAction = (props) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { onClick: () => setVisible(true), title: t('Add category') },
      children || React.createElement(PlusOutlined, null),
    ),
...
//# sourceMappingURL=AddCategoryAction.js.map

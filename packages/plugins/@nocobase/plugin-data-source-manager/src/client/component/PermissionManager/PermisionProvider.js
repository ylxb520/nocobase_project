...
export const RoleRecordProvider = (props) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      { value: { dataSourceKey: record.key } },
      React.createElement(SchemaComponentOptions, { scope: { dataSourceKey: record.key } }, props.children),
    ),
  );
};
//# sourceMappingURL=PermisionProvider.js.map

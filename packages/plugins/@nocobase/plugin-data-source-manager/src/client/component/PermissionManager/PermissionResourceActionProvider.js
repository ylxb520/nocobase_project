...
export const PermissionResourceActionProvider = (props) => {
  ...
  return React.createElement(ResourceActionProvider, { ...props, request: modifiedRequest }, props.children);
};
//# sourceMappingURL=PermissionResourceActionProvider.js.map

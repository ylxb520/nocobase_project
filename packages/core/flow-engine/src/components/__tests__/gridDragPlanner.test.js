...
import { simulateLayoutForSlot, getSlotKey, resolveDropIntent } from '../dnd/gridDragPlanner';
const rect = { top: 0, left: 0, width: 100, height: 100 };
const createLayout = (rows, sizes, rowOrder) => ({
  rows,
  sizes,
  rowOrder,
});
...
//# sourceMappingURL=gridDragPlanner.test.js.map

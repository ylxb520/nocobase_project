...
describe('VariableInput', () => {
  ...
  it('should render Input for static values', async () => {
    ...
    render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(VariableInput, { value: 'static text', metaTree: () => flowContext.getPropertyMetaTree() }),
      ),
    );
  ...
  it('should render FlowContextSelector button', async () => {
    ...
    render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(VariableInput, { value: 'test', metaTree: () => flowContext.getPropertyMetaTree() }),
      ),
    );
  ...
  it('should handle clear action from VariableTag', async () => {
    ...
    const selectInstance = selectElement;
    // 尝试通过键盘事件触发清除
  ...
  it('should handle external prop updates', async () => {
    ...
    const { rerender } = render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(VariableInput, { value: 'initial', metaTree: () => flowContext.getPropertyMetaTree() }),
      ),
    );
  ...
  it('should handle empty metaTree', async () => {
    ...
    render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(VariableInput, { value: 'test', metaTree: [] }),
      ),
    );
    const input = await screen.findByDisplayValue('test');
    expect(input).toBeInTheDocument();
  ...
  it('should handle undefined value', async () => {
    ...
    render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(VariableInput, { metaTree: () => flowContext.getPropertyMetaTree() }),
      ),
    );
    ...
    const TestWrapper = () => {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('button', { onClick: () => setValue('test2') }, 'Change Value'),
        ),
      );
    };
    render(React.createElement(TestWrapper, null));
  ...
  it('should handle different field types correctly', async () => {
    ...
    render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(VariableInput, { value: '', metaTree: () => flowContext.getPropertyMetaTree() }),
      ),
    );
    const input = await screen.findByRole('textbox');
    expect(input).toBeInTheDocument();
...
//# sourceMappingURL=VariableInput.test.js.map

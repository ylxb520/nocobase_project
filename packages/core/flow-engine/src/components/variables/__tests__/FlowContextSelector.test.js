  ...
  it('should render with default children', async () => {
    ...
    render(
      React.createElement(
        ...
        { context: flowContext },
        React.createElement(FlowContextSelector, { metaTree: () => flowContext.getPropertyMetaTree() }),
      ),
    );
    await waitFor(() => {
    ...
    render(
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('button', null, 'Custom Button'),
        ),
      ),
    );
    await waitFor(() => {
  ...
  it('should support function metaTree loading', async () => {
    ...
    render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(FlowContextSelector, { metaTree: metaTreeFn }),
      ),
    );
    const cascader = screen.getByRole('button');
    fireEvent.click(cascader);
  ...
  it('should support async metaTree function', async () => {
    ...
    render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(FlowContextSelector, { metaTree: asyncMetaTree }),
      ),
    );
    const cascader = screen.getByRole('button');
    fireEvent.click(cascader);
  ...
  it('should load and expand lazy relation node after searching', async () => {
    ...
    render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(FlowContextSelector, { metaTree: metaTree, showSearch: true, onlyLeafSelectable: true }),
      ),
    );
    fireEvent.click(screen.getByRole('button'));
    const searchInput = await screen.findByPlaceholderText('Search');
  ...
  it('should support inline search input when children is null and keep lazy expand', async () => {
    ...
    render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(FlowContextSelector, { metaTree: metaTree, onlyLeafSelectable: true }, null),
      ),
    );
  ...
  it('should keep dropdown open on first pointer click in inline input mode', async () => {
    ...
    render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(FlowContextSelector, { metaTree: () => flowContext.getPropertyMetaTree() }, null),
      ),
    );
  ...
  it('should show selected path text when inline input dropdown is closed', async () => {
    ...
    render(
      React.createElement(
        ...
        React.createElement(
          FlowContextSelector,
          { metaTree: () => flowContext.getPropertyMetaTree(), value: '{{ ctx.user.name }}' },
          null,
        ),
      ),
    );
  ...
  it('should clear selected value when clearing inline input while dropdown is closed', async () => {
    ...
    render(
      React.createElement(
        ...
        React.createElement(
          FlowContextSelector,
          { metaTree: () => flowContext.getPropertyMetaTree(), value: '{{ ctx.user.name }}', onChange: onChange },
          null,
        ),
      ),
    );
  ...
  it('should handle empty metaTree', async () => {
    ...
    render(
      React.createElement(
        TestFlowContextWrapper,
        { context: flowContext },
        React.createElement(FlowContextSelector, { metaTree: [] }),
      ),
    );
    await waitFor(() => {
      const cascader = screen.getByRole('button');
    ...
    it('should control dropdown open state with open prop', async () => {
      ...
      const { rerender } = render(
        React.createElement(
          TestFlowContextWrapper,
          { context: flowContext },
          React.createElement(FlowContextSelector, { metaTree: () => flowContext.getPropertyMetaTree(), open: false }),
        ),
      );
      ...
      rerender(
        React.createElement(
          TestFlowContextWrapper,
          { context: flowContext },
          React.createElement(FlowContextSelector, { metaTree: () => flowContext.getPropertyMetaTree(), open: true }),
        ),
      );
    ...
    it('should handle invalid metaTree function', async () => {
      ...
      render(
        React.createElement(
          TestFlowContextWrapper,
          { context: flowContext },
          React.createElement(FlowContextSelector, { metaTree: invalidMetaTree }),
        ),
      );
      const cascader = screen.getByRole('button');
      fireEvent.click(cascader);
    ...
    it('should handle null/undefined metaTree', () => {
      ...
      render(
        React.createElement(
          TestFlowContextWrapper,
          { context: flowContext },
          React.createElement(FlowContextSelector, { metaTree: undefined }),
        ),
      );
      const cascader = screen.getByRole('button');
      fireEvent.click(cascader);
...
//# sourceMappingURL=FlowContextSelector.test.js.map

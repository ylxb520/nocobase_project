 ...
 */
const findMetaTreeNodeByPath = (metaTree, targetPath) => {
 ...
 */
const isPathPrefix = (pathA, pathB) => {
...
const VariableInputComponent = ({
  ...
  const [currentMetaTreeNode, setCurrentMetaTreeNode] = useState(null);
  ...
  const handleInputChange = useCallback(
    (e) => {
      ...
      const isComposing = composingRef.current || (e?.nativeEvent && e.nativeEvent.isComposing);

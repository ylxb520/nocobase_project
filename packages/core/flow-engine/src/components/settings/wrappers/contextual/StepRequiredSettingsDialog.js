...
const MultiStepContextProvider = ({ model, requiredSteps, formStep, children }) => {
  // 获取当前步骤索引
  ...
  return React.createElement(FlowSettingsContextProvider, { value: flowRuntimeContext }, children);
};
/**
 ...
 */
const openRequiredParamsStepFormDialog = async ({ model, dialogWidth = 800, dialogTitle }) => {
  const t = getT(model);
          ...
          (form) => {
            ...
            return React.createElement(
              ...
              React.createElement(
                ...
                { model: model, requiredSteps: requiredSteps, formStep: formStep },
              ...
              React.createElement(FormConsumer, null, () =>
                React.createElement(
                  'div',
                  {
                    style: {
...
//# sourceMappingURL=StepRequiredSettingsDialog.js.map

...
const getSelectedPathInfo = (path, options) => {
...
const FlowContextSelectorComponent = ({
  value,
  onChange,
  children,
  metaTree,
        ...
        const label = disabled
          ? React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(QuestionCircleOutlined, { style: { marginLeft: 6, color: 'rgba(0,0,0,0.35)' } }),
              ),
            )
          : baseLabel;
        return {
  ...
  const defaultChildren = useMemo(() => {
    ...
    return React.createElement(Button, { type: hasSelected ? 'primary' : 'default', style: defaultButtonStyle }, 'x');
  }, [currentPath]);
  // 处理选择变化事件
  ...
  const renderDropdown = useCallback(
    (menu) => {
      ...
      const cascaderMenu = React.isValidElement(cascaderMenuNode)
        ? cascaderMenuNode
        : React.createElement(React.Fragment, null, cascaderMenuNode);
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          { className: cascaderSearchInputClassName },
...
//# sourceMappingURL=FlowContextSelector.js.map

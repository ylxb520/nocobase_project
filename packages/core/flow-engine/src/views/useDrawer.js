...
export function useDrawer() {
  ...
  const RenderNestedDrawer = React.memo((props) => {
    ...
    return React.createElement(RenderDrawer, null, React.createElement(RenderNestedDrawer, { index: index + 1 }));
  });
      ...
      observer((props) => {
        ...
        const content =
          typeof rawContent === 'string'
            ? React.createElement('div', { dangerouslySetInnerHTML: { __html: DOMPurify.sanitize(rawContent) } })
            : rawContent;
        // eslint-disable-next-line react-hooks/rules-of-hooks
        React.useEffect(() => {
    ...
    const RenderDrawer = React.memo(({ children }) =>
      React.createElement(
        ...
        React.createElement(
          ...
          { context: ctx },
          React.createElement(DrawerWithContext, null, children),
        ),
      ),
    );
  ...
  const ElementsHolder = React.memo(
    React.forwardRef((props, ref) => {
      ...
      return React.createElement(RenderNestedDrawer, { index: 0 });
    }),
  );

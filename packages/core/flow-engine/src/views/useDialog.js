...
export function useDialog() {
  ...
  const open = (config, flowContext) => {
    ...
    const dialog = React.createElement(
      ...
      React.createElement(FlowViewContextProvider, { context: ctx }, React.createElement(DialogWithContext, null)),
    );
  ...
  return [api, React.createElement(ElementsHolder, { key: 'dialog-holder', ref: holderRef })];
}

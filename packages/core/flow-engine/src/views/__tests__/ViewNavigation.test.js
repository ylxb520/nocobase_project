...
describe('ViewNavigation', () => {
  ...
  describe('changeTo', () => {
    ...
    it('should keep viewStack unchanged with complex parameters', () => {
      ...
      expect(
        mockCtx.router.navigate,
      ).toHaveBeenCalledWith('/admin/view1/view/new-view/tab/new-tab/filterbytk/123/sourceid/source1', {
        replace: true,
      });
    });
  ...
  describe('navigateTo', () => {
    it('should navigate to new view', () => {
      ...
      const call = mockCtx.router.navigate.mock.calls[0];
...
describe('generatePathnameFromViewParams', () => {
  it('should handle empty array', () => {
    ...
    expect(generatePathnameFromViewParams(null)).toBe('/admin');
    expect(generatePathnameFromViewParams(undefined)).toBe('/admin');
  });
...
//# sourceMappingURL=ViewNavigation.test.js.map

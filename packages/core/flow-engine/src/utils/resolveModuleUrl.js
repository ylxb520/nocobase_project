 ...
 * ```
 */
export function resolveModuleUrl(url, options) {
  ...
  const ESM_CDN_SUFFIX = options?.addSuffix ? window['__esm_cdn_suffix__'] || '' : '';
...
//# sourceMappingURL=resolveModuleUrl.js.map

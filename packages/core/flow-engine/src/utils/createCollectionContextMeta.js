 ...
 */
function createMetaBaseProperties(field) {
  return {
...
export function createCollectionContextMeta(collectionOrFactory, title, includeNonFilterable) {
  const metaFn = async () => {
...
//# sourceMappingURL=createCollectionContextMeta.js.map

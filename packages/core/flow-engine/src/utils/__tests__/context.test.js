...
describe('Context Utils', () => {
  describe('extractPropertyPath', () => {
    ...
    it('should return null for non-string values', () => {
      expect(extractPropertyPath(123)).toBeNull();
      expect(extractPropertyPath(null)).toBeNull();
      expect(extractPropertyPath(undefined)).toBeNull();
      expect(extractPropertyPath({})).toBeNull();
    });
  });

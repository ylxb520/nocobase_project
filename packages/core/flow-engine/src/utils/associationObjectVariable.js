 ...
 */
export function createAssociationSubpathResolver(collectionAccessor, valueAccessor) {
  return (p) => {
    // 仅在访问子属性时才考虑后端
 ...
 */
export function createAssociationAwareObjectMetaFactory(collectionAccessor, title, valueAccessor) {
...
//# sourceMappingURL=associationObjectVariable.js.map

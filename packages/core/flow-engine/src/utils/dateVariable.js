...
export function isCtxDatePathPrefix(pathSegments) {
...
export function isCtxDateExpression(value) {
  if (typeof value !== 'string') return false;
  return CTX_DATE_REGEX.test(value.trim());
}
export function isCompleteCtxDatePath(pathSegments) {
...
export function parseCtxDateExpression(value) {
...
export function serializeCtxDateValue(value) {
...
export function resolveCtxDatePath(pathSegments) {
  const segments = withDatePrefix((pathSegments || []).map((seg) => String(seg)));

...
import { FlowForkModelContext } from '../flowContext';
...
export class ForkFlowModel {
  ...
  forkId;
  /** 需要与 master 共享的属性列表 */
  static SHARED_PROPERTIES = ['stepParams', 'sortIndex'];
  /**
  ...
  constructor(master, initialProps = {}, forkId) {
    ...
    return new Proxy(this, {
      get: (target, prop, receiver) => {
        ...
        // 默认取 master 上的值
        const value = target.master?.[prop];
  ...
  get context() {
    if (!this['#flowContext']) {
      this['#flowContext'] = new FlowForkModelContext(this.master, this);
    }
...
//# sourceMappingURL=forkFlowModel.js.map

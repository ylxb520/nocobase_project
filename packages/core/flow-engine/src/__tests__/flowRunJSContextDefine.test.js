...
describe('FlowRunJSContext.define() and getDoc() deep tests', () => {
  ...
  beforeEach(() => {
    ...
    const cache = FlowRunJSContext.__runjsDocCache;
    if (cache) {
  ...
  describe('Deep merging', () => {
    it('should deep merge nested object properties', () => {
      ...
      const apiProp = doc.properties?.api;
    ...
    it('should deep merge method documentation', () => {
      ...
      const method = doc.methods?.runAction;
...
//# sourceMappingURL=flowRunJSContextDefine.test.js.map

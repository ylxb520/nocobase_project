...
describe('observer', () => {
  ...
  it('should render component', () => {
    const Component = observer(() => React.createElement('div', null, 'Hello World'));
  ...
  it('should update when observable changes', async () => {
    ...
    const Component = observer(() => React.createElement('div', null, 'Count: ', model.count));
    render(React.createElement(Component, null));
  ...
  it('should delay update when pageActive is false', async () => {
    ...
    useFlowContext.mockReturnValue(context);
    const Component = observer(() => React.createElement('div', null, 'Count: ', model.count));
    render(React.createElement(Component, null));
    expect(screen.getByText('Count: 0')).toBeInTheDocument();

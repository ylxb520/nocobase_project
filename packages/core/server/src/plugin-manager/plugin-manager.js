...
export class PluginManager {
  ...
  static async parseName(nameOrPkg) {
    ...
    const exists = async (name, isPreset = false) => {
      return fs.exists(
  ...
  async add(plugin, options = {}, insert = false, isUpgrade = false) {
    ...
    const instance = new P(createAppProxy(this.app), options);
  ...
  async load(options = {}) {
    ...
    const getSourceAndTargetForAddAction = async (ctx) => {
    ...
    const getSourceAndTargetForUpdateAction = async (ctx) => {
    ...
    const getSourceAndTargetForOtherActions = async (ctx) => {

 ...
 */
import { BelongsToManyRepository, createMockDatabase, HasManyRepository } from '@nocobase/database';
describe('has many with target key', function () {
  ...
  test('destroy by target key and filter', async () => {
    ...
    const UserPostRepository = new HasManyRepository(User, 'posts', u1.get('name'));
...
//# sourceMappingURL=has-many-repository.test.js.map

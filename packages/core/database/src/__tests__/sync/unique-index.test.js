...
describe('unique index', () => {
  ...
  it('should sync unique index', async () => {
    ...
    const userTableInfo = await db.sequelize.getQueryInterface().showIndex(User.getTableNameWithSchema());
    ...
    await db.sync();
    const userTableInfo2 = await db.sequelize.getQueryInterface().showIndex(User.getTableNameWithSchema());
...
//# sourceMappingURL=unique-index.test.js.map

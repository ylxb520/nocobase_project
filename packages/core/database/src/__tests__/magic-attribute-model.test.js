 ...
 */
import { createMockDatabase, MagicAttributeModel } from '@nocobase/database';
describe('magic-attribute-model', () => {
  ...
  it('case 2', async () => {
    ...
    test.set('x-component-props', { arr2: [1, 2, 3] });
    await test.save();
    test = await Test.model.findByPk(test.get('id'));
    await test.update({
...
//# sourceMappingURL=magic-attribute-model.test.js.map

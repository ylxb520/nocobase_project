 ...
 */
import { createMockDatabase, updateAssociations } from '@nocobase/database';
describe('update associations', () => {
  ...
  describe('hasMany', () => {
    ...
    it('user.posts', async () => {
      await User.model.create({ name: 'user01' });
      await User.model.create({ name: 'user02' });
      const user1 = await User.model.create({ name: 'user1' });
...
//# sourceMappingURL=update-associations.test.js.map

...
import { checkDeleteSetting } from './delete';
import { checkModalSetting } from './modal';
import { checkSwitchSetting } from './switch';
import { checkSelectSetting } from './select';
...
export async function checkSettings(list, checkLength = false) {
  if (checkLength) {

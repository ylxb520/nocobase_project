...
export async function showSettingsMenu(container = document) {
  await waitFor(() => {
...
export const renderSettings = async (options = {}) => {
...
export const renderReadPrettySettings = async (options = {}) => {
  const { container = () => document, ...appOptions } = options;
...
//# sourceMappingURL=renderSettings.js.map

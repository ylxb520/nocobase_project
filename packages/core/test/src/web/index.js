...
export const mockApi = (axiosInstance, apis = {}, delayResponse) => {
...
export const mockAppApi = (app, apis = {}, delayResponse) => {
...
const ShowFormData = observer(({ children }) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      'pre',
      { style: { marginBottom: 20 }, 'data-testid': 'form-data' },
...
export const getAppComponent = (options) => {
  const {
...
export function addXReadPrettyToEachLayer(obj = {}) {
...
export const getReadPrettyAppComponent = (options) => {
  return getAppComponent({ ...options, schema: addXReadPrettyToEachLayer(options.schema) });
};
export function setSchemaWithSettings(options) {
...
export const getAppComponentWithSchemaSettings = (options) => {
  setSchemaWithSettings(options);
  const App = getAppComponent(options);
  return App;
};
export const getReadPrettyAppComponentWithSchemaSettings = (options) => {
  setSchemaWithSettings(options);
  set(options.schema, 'x-read-pretty', true);
  const App = getAppComponent(options);
  return App;
};
export function withSchema(Component, name) {
  const ComponentValue = observer((props) => {
    ...
    return React.createElement(
      ...
      React.createElement(
        'pre',
        { 'data-testid': name ? `test-schema-${name}` : `test-schema` },
...
export const CommonSchemaComponent = withSchema(function CommonSchemaComponent(props) {

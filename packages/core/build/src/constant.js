...
export const getPluginPackages = (packages) =>
  packages
...
export const getPresetsPackages = (packages) => packages.filter((item) => item.location.startsWith(PRESETS_DIR));
...
export const getCjsPackages = (packages) =>
  packages

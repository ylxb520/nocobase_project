...
import { getPackageJson, getPkgLog, getUserConfig, readFromCache, toUnixPath, writeToCache } from './utils';
...
export async function buildPackages(packages, targetDir, doBuildPackage) {
  for await (const pkg of packages) {
    writeToCache(BUILD_ERROR, { pkg: pkg.name });
    await buildPackage(pkg, targetDir, doBuildPackage);
  }
}
export async function buildPackage(pkg, targetDir, doBuildPackage) {

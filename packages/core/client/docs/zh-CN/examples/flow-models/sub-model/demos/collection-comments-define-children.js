...
class ContainerModel extends FlowModel {
  render() {
    return React.createElement(
      ...
      React.createElement(
        AddSubModelButton,
        { model: this, subModelKey: 'items', subModelBaseClass: CollectionBlockModel },
        React.createElement(Button, null, '\u6DFB\u52A0\u533A\u5757'),
      ),
    );
  }
}
...
class CommentsBlockModel extends CollectionBlockModel {
  ...
  static getChildrenFilters(ctx) {
    return {
      ...
      collections: (ctx) => {
        ...
        const allCollections = mainDS.getCollections();
  ...
  renderComponent() {
    ...
    return React.createElement(
      'div',
      { style: { padding: 16, border: '1px solid #d9d9d9', borderRadius: 4 } },
      React.createElement('h3', null, '\u8BC4\u8BBA\u533A\u5757'),
      React.createElement('p', null, '\u5F53\u524D\u96C6\u5408: ', collection?.title || collection?.name || '未选择'),
      React.createElement(
        'p',
...
class UsersBlockModel extends CollectionBlockModel {
  ...
  renderComponent() {
    ...
    return React.createElement(
      'div',
      { style: { padding: 16, border: '1px solid #d9d9d9', borderRadius: 4 } },
      React.createElement('h3', null, '\u7528\u6237\u533A\u5757'),
      React.createElement('p', null, '\u5F53\u524D\u96C6\u5408: ', collection?.title || collection?.name || '未选择'),
      React.createElement(
        'p',
        { style: { color: '#888', fontSize: 12 } },
...
//# sourceMappingURL=collection-comments-define-children.js.map

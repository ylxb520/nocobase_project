...
class FooterExampleModel extends FlowModel {
  render() {
    return React.createElement(Button, null, 'Footer Configuration Examples');
  }
}
      ...
      uiMode: {
        ...
        props: {
          ...
          footer: React.createElement(
            ...
            React.createElement(Button, { type: 'primary', size: 'large' }, 'Custom Save'),
          ),
        },
      },
      handler(ctx, params) {},
          ...
          footer: (originNode, { OkBtn, CancelBtn }) =>
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  Tooltip,
                  { title: 'Need help? Click here for documentation' },
                  React.createElement(QuestionCircleOutlined, { style: { color: '#1890ff', cursor: 'pointer' } }),
                ),
                React.createElement(
                  'span',
        ...
        props: {
          ...
          footer: (originNode, { OkBtn, CancelBtn }) =>
            React.createElement(
              Space,
              null,
              React.createElement(CancelBtn, { title: 'Close' }),
              React.createElement(
                Button,
                {
                  type: 'link',
              ...
              React.createElement(OkBtn, { title: 'Save & Close' }),
            ),
        },
      },
      handler(ctx, params) {},

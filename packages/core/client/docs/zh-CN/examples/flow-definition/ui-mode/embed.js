...
import { defineFlow, FlowModel, FlowModelRenderer, useFlowContext } from '@nocobase/flow-engine';
  ...
  steps: {
    step1: {
      ...
      uiMode: {
        ...
        props: {
          footer: (originNode) =>
            React.createElement(Space, null, React.createElement(PreviewButton, null), originNode),
        },
      },
      uiSchema: {
        title: {

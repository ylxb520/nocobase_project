...
class BaseModel extends FlowModel {
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        Button,
        { type: 'primary', onClick: () => this.applyFlow('testFlow') },
      ...
      element: React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            null,
            'Model1 \u8986\u76D6\u4E86\u57FA\u7C7B action\uFF0CModel2 \u7EE7\u627F\u57FA\u7C7B action',
          ),
          React.createElement(
            Space,
            null,
...
//# sourceMappingURL=global-and-class-actions.js.map

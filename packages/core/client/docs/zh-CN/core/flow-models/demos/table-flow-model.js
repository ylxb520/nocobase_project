  ...
  renderActions() {
    return React.createElement(
      ...
      this.subModels.actions.map((action) => {
        return React.createElement(FlowModelRenderer, { key: action.uid, model: action });
      }),
      React.createElement(
        Dropdown,
        {
        ...
        React.createElement(Button, null, 'Add action'),
      ),
    );
  }
  render() {
    return React.createElement(
      ...
      React.createElement('br', null),
      React.createElement(Table, { ...this.props, scroll: { x: 'max-content' }, columns: this.getColumns() }),
    );
  }
}
...
//# sourceMappingURL=table-flow-model.js.map

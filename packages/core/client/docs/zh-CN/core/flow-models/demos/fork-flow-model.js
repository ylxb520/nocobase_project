...
class HelloFlowModel extends FlowModel {
  render() {
    ...
    return React.createElement(
      Card,
      null,
      React.createElement('div', { style: { marginTop: 8 } }, 'name: ', name),
      React.createElement('div', { style: { marginTop: 8, color: color || '#333' } }, 'color: ', color),
    );
  }
}
  ...
  async load() {
    ...
    this.router.add('root', {
      ...
      element: React.createElement(
        Space,
        null,
        React.createElement(FlowModelRenderer, { model: master, showFlowSettings: true }),
...
//# sourceMappingURL=fork-flow-model.js.map

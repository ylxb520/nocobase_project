...
class MyModel extends FlowModel {
  render() {
    return React.createElement(
      'span',
      null,
      React.createElement(FlowModelRenderer, { model: this.subModels.sub, showFlowSettings: true }),
    );
  }
}
...
class MySub1Model extends MySubModel {
  render() {
    return React.createElement('span', null, 'MySub1Model');
  }
}
class MySub2Model extends MySubModel {
  render() {
    return React.createElement('span', null, 'MySub2Model');
  }
}

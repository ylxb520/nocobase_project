...
class DemoBlockModel extends BlockModel {
  render() {
    return React.createElement(
      'div',
      { style: { padding: 8, border: '1px solid #ddd', borderRadius: 4, backgroundColor: '#f9f9f9' } },
      React.createElement('h3', null, 'Demo Block - #', this.uid),
      React.createElement('p', null, 'This is a demo block content.'),
    );
  }
}
// 插件定义
...
//# sourceMappingURL=grid-model-basic.js.map

  ...
  render() {
    ...
    const DemoContent = observer(() => {
      ...
      return React.createElement(
        ...
        React.createElement(
          Card,
          { size: 'small', title: '\u53D8\u91CF\u7B5B\u9009\u9879\u7EC4\u4EF6\u793A\u4F8B' },
          React.createElement(VariableFilterItem, { value: filterValue, model: self }),
          React.createElement(
            'div',
            { style: { marginTop: 24 } },
            React.createElement(Text, { strong: true }, '\u5F53\u524D\u7B5B\u9009\u6761\u4EF6\uFF1A'),
            React.createElement(
              Paragraph,
              null,
              React.createElement(
            ...
            React.createElement(Text, { strong: true }, 'transformFilter \u8F6C\u6362\u7ED3\u679C\uFF1A'),
            React.createElement(
              Paragraph,
              null,
              React.createElement(
                'pre',
                { style: { backgroundColor: '#f0f9ff', padding: 12, borderRadius: 4 } },
    ...
    return React.createElement(DemoContent, null);
  }
}
...
//# sourceMappingURL=variable-filter-item-basic.js.map

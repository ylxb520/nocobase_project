...
import { Application, MockFlowModelRepository, Plugin, FilterManager } from '@nocobase/client';
    ...
    this.router.add('root', {
      ...
      element: React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Card,
            { title: 'CreateForm + JSEditableField\uFF08\u8FDC\u7A0B\u641C\u7D22 + \u865A\u62DF\u6EDA\u52A8\uFF09' },
            React.createElement(FlowModelRenderer, { model: form, showFlowSettings: true }),
          ),
        ),
      ),
    });
...
//# sourceMappingURL=remote-search-virtual.js.map

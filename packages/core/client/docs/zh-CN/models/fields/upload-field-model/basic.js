  ...
  render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(FieldModelRenderer, { model: this.subModels.field, target: 'attachments' }),
      ),
      React.createElement(
        FormItem,
        { rules: [{ required: true }], label: 'File1', name: 'file1' },
        React.createElement(CardUpload, null),
      ),
    );
  }
}

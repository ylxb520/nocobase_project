...
const bootstrapMock = (api) => {
  ...
  mock.onPost('lead:destroy').reply((config) => {
    const ids = (config.params?.filterByTk || []).map((value) => Number(value));
    ids.forEach((id) => {
      ...
      element: React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Card,
            { title: 'JSBlock + openView\uFF08\u5916\u7F6E\u8868\u5355\u914D\u7F6E\uFF09' },
            React.createElement(FlowModelRenderer, { model: page, showFlowSettings: true }),
          ),
        ),
      ),
    });
...
//# sourceMappingURL=jsblock-open-edit-after-submit-external.js.map

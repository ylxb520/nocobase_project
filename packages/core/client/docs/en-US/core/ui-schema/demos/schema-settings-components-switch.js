...
const FormItemRequired = () => {
  ...
  return React.createElement(SchemaSettingsSwitchItem, {
    title: 'Required - 组件方式',
...
const Hello = observer((props) => {
  return React.createElement(
    ...
    React.createElement(
      Form.Item,
      { name: 'note', label: 'Note', rules: [{ required: props.required }] },
...
//# sourceMappingURL=schema-settings-components-switch.js.map

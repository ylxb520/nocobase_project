...
import { transformFilter, evaluateConditions, removeInvalidFilterItems } from '../transformFilter';
describe('transformFilter', () => {
  ...
  describe('Error handling', () => {
    it('should throw error when null is passed', () => {
      expect(() => transformFilter(null)).toThrow('Invalid filter: filter must be an object');
    });
    it('should throw error when undefined is passed', () => {
      expect(() => transformFilter(undefined)).toThrow('Invalid filter: filter must be an object');
    });
    it('should throw error when non-object type is passed', () => {
      expect(() => transformFilter('invalid')).toThrow('Invalid filter: filter must be an object');
    });
...
describe('evaluateConditions', () => {
  // 创建一个简单的条件评估器用于测试
  const createMockEvaluator = (mockData) => {
  ...
  describe('Error handling', () => {
    ...
    it('should throw error when null conditions are passed', () => {
      expect(() => evaluateConditions(null, mockEvaluator)).toThrow('Invalid conditions: conditions must be an object');
    });
    it('should throw error when undefined conditions are passed', () => {
      expect(() => evaluateConditions(undefined, mockEvaluator)).toThrow(
        'Invalid conditions: conditions must be an object',
      );
    });
    it('should throw error when non-object conditions are passed', () => {
      expect(() => evaluateConditions('invalid', mockEvaluator)).toThrow(
        'Invalid conditions: conditions must be an object',
      );
    });
    it('should throw error when logic property is missing', () => {
    ...
    it('should throw error when items is not an array', () => {
      const conditions = { logic: '$and', items: 'not-array' };
    ...
    it('should throw error when evaluator is not a function', () => {
      ...
      expect(() => evaluateConditions(conditions, 'not-function')).toThrow(
...
//# sourceMappingURL=transformFilter.test.js.map

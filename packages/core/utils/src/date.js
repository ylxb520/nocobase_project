...
export const getDefaultFormat = (props) => {
  if (props.format) {
    return props.format;
  }
  if (props.dateFormat) {
...
export const str2moment = (value, options = {}) => {
...
export const moment2str = (value, options = {}) => {
 ...
 */
export function offsetFromString(string) {
...
export function getFormatFromDateStr(dateStr) {
